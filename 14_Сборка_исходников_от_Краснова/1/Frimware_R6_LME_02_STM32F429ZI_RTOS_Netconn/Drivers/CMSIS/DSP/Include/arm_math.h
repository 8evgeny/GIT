...
#define __PACKq7(v0,v1,v2,v3) ( (((int32_t)(v3) <<  0) & (int32_t)0x000000FF) | \
  ...
  q31_t * pRecipTable)
  {
    ...
    log_index = (uint32_t)(in >> 24);
    log_index = (log_index & INDEX_MASK);

    /* 1.31 with exp 1 */
    out = pRecipTable[log_index];
 ...
 */
 ...
 /**
  ...
  uint32_t nValues)
  {
    ...
    int32_t log_index;                               /* Index to read nearest output values */

    /* Input is in 12.20 format */
    /* 12 bits for the table index */
    /* Index value calculation */
    log_index = ((x & (q31_t)0xFFF00000) >> 20);

    if (log_index >= (int32_t)(nValues - 1))
    {
  ...
  uint32_t nValues)
  {
    ...
    /* 12 bits for the table index */
    /* Index value calculation */
    log_index = ((x & (int32_t)0xFFF00000) >> 20);
  ...
  uint32_t nValues)
  {
    ...
    q31_t fract;                                 /* fractional part */
    uint32_t log_index;                              /* Index to read nearest output values */
    ...
    log_index = (x >> 20) & 0xfff;

    if (log_index >= (nValues - 1))
    {
      return (pYData[nValues - 1]);
    }
    else
 ...
 */
  ...
  */
  ...
  float32_t Y)
  {
    ...
    int32_t xIndex, yIndex, log_index;
    ...
    log_index = (xIndex - 1) + (yIndex - 1) * S->numCols;


    /* Read two nearest points in X-direction */
    f00 = pData[log_index];
    f01 = pData[log_index + 1];

    /* Calculation of index for two nearest points in Y-direction */
    log_index = (xIndex - 1) + (yIndex) * S->numCols;


    /* Read two nearest points in Y-direction */
    f10 = pData[log_index];
    f11 = pData[log_index + 1];
