...
var str = "";
var NUM_LINES = 6;
var verbose = true; // display "sohraneno" or not
...
function pollAJAX() {	
	...
	// Call ourselves again in 1000ms
...
var starter = "\x01", divider = "\x02", ender = "\n";

function addToStrNameAndValue(id) {
	...
	if (elem.type == "checkbox") {
		if (elem.checked) val = "1";
		else val = "0"
	} else {
		val = elem.value;
	}
	str += starter + elem.name + divider + val + ender;
}
