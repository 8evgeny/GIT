  /**
  @addtogroup UART_Printf UART_Printf for MDR1986VE91 evaluation board
  @latexonly
  @verbatim
...
@par Hardware and Software environment:
    ...
    - This example is intended to run on MDR1986VE91 evaluation board with MDR1986VE91 microcontroller.
    - UART2_RXD and UART2_TXD lines of MCU are connected on evaluation board to the RS-232 transceiver.
    - Connect USB-RS232 cable between PC and evaluation board (DB9 connector XP14) to display data on a terminal (for example PuTTY).
