  /**
  @addtogroup DMA_UART_RAM_93 DMA_UART_RAM for MDR1986VE93 evaluation board
  @latexonly
  @verbatim
...
Data received by UART2 is transferred by DMA and stored in DstBuf2 then compared with
