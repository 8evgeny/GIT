...
#ifdef USE_RS485
  #define RS485_TX()      (HAL_GPIO_WritePin(USART3_485_DE_GPIO_Port, USART3_485_DE_Pin, GPIO_PIN_SET))
  #define RS485_RX()      (HAL_GPIO_WritePin(USART3_485_DE_GPIO_Port, USART3_485_DE_Pin, GPIO_PIN_RESET))
#endif

#define USART_IRQ_HANDLER    USART3_IRQHandler // обработчик прерывания
#define uart	USART3
...
unsigned short uartTxBufferEmpty(void) {
	return !FIFO_COUNT(uart_tx_fifo);
}

#ifdef USE_RS485
unsigned short uartRS485TxBusy(void) {
	return HAL_GPIO_ReadPin(USART3_485_DE_GPIO_Port, USART3_485_DE_Pin);
}
#endif
