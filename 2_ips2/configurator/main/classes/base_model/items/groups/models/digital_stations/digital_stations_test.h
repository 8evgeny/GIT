...
#include "classes/base_model/items/table_models/model_table_groups/model_table_digital_stations/model_table_digital_stations.h"

TEST_CASE("Test case tabledigitalstations class") {
   ModelTableDigitalStations m;
