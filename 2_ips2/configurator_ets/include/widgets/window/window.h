...
class Window {
 ...
 public:
     ...
     *      dialog::init(this, name(), m_title, {{this, 600}, {QStringLiteral("table"), ui->m_table}});
     *      dialog::init(this, QStringLiteral("Notepad"), iTitle::tr("Notepad"), {{this, ps2::Fraction3{2}}});
     * \endcode
    **/
    ...
    /**
     * \code
     *      dialog::init({{this, 400}});
     *      dialog::init({{this, default_t::Adjusted}});
     * \endcode
    **/
