...
extern char g_ufw_mac_valid;
extern uint8_t g_ufw_mac_settings[6];
...
void HAL_ETH_MspInit(ETH_HandleTypeDef* ethHandle)
{
  ...
  /* USER CODE END ETH_MspInit 0 */
    ...
    */
    ...
    HAL_NVIC_SetPriority(ETH_IRQn, 5, 0); //TODO: Configure prio as is
...
/* USER CODE END OS_THREAD_ATTR_CMSIS_RTOS_V2 */
  ...
  MACAddr[4] = 0x00;
  MACAddr[5] = 0x00;
  if(g_ufw_mac_valid==0xFA)
    {
      heth.Init.MACAddr = &g_ufw_mac_settings[0];
    }
  else
    {
