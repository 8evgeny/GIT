...
ApplicationWindow {
    ...
    height: 320
    title: nameTitle
    property string nameTitle: qsTr("List of Appointments RS232")
...
//        setCoordinates()
        ...
        appCore.getListOfStationsRs232()
    }
}

/*##^##
Designer {
    D{i:3;anchors_height:300}D{i:1;anchors_height:320;anchors_width:325}
}
##^##*/
