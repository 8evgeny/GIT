  /**
  @addtogroup UART_Interrupt UART_Interrupt for MDR1986BE4 evaluation board
  @latexonly
  @verbatim
...
Configure PORTB lines 0 as UART1_TXD.
Configure PORTC lines 1 as UART2_RXD.
...
@par Hardware and Software environment:
    ...
    - This example is intended to run on MDR1986BE4 eval board with 1986BE4 microcontroller.
    - Pin of XP59 (UART1_TXD) and Pin of XP18 (UART2_RXD) must be connected together.
