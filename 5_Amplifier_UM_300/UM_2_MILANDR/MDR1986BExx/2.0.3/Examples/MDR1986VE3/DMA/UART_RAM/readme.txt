  /**
  @addtogroup DMA_UART_RAM_3T DMA_UART_RAM for MDR1986VE3 evaluation board
  @latexonly
  @verbatim
...
Data received by UART2 is transferred by DMA and stored in DstBuf1 then compared with
