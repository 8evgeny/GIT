  /**
  @addtogroup UART_Printf UART_Printf for MDR1986VE93 evaluation board
  @latexonly
  @verbatim
...
Configure PORTB line 5 as UART1_TXD.
Configure PORTB line 6 as UART1_RXD.
...
@par Hardware and Software environment:
    ...
    - This example is intended to run on MDR1986VE93 evaluation board with MDR1986VE93 microcontroller.
    - UART1_TXD and UART1_RXD lines of MCU are connected on evaluation board to the RS-232 transceiver.
    - Connect USB-RS232 cable between PC and evaluation board (DB9 connector XP12) to display data on a terminal (for example PuTTY).
