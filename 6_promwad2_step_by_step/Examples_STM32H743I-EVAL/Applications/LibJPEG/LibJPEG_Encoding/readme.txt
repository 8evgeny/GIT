...
This application demonstrates how to use the libjpeg API to encode and decode a BMP image into a
jpeg file.
...
Then a BMP file is read form th micro SD, encoded into a jpeg filei that is saved in the SD card root then decoded and displayed on the LCD.
...
Display, Graphics, LibJPEG, LTDC, SDMMC, SD Card, LCD, Decoding, Flash memory, DMA2D, ARGB8888, RGB, BMP, JPG
