...
World" application based on STemWin for STM32H743xx Devices.
...
Note that the following user files may need to be updated:
  LCDConf_STM32H743I-EVAL.c  
  GUIConf_STM32H743I-EVAL.c
...
@par Directory contents 
  ...
  - STemWin/STemWin_HelloWorld/STemWin/Target/LCDConf_STM32H743I-EVAL.c  Display controller initialization
  - STemWin/STemWin_HelloWorld/STemWin/Target/GUIConf_STM32H743I-EVAL.c  Configuration file for the GUI library
