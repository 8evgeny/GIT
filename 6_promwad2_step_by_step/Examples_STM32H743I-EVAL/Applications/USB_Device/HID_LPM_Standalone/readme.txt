...
The STM32H7xx devices support the USB Link Power Management Protocol (LPM-L1) and complies with the USB 2.0
...
Connectivity, USB_Device, USB, HID, Full Speed, Mouse, Remote Wakeup, Power Management Protocol, LPM, Lowpower mode, Stop

@par Directory contents

  - USB_Device/HID_LPM_Standalone/Src/main.c                  Main program
  - USB_Device/HID_LPM_Standalone/Src/system_stm32h7xx.c      STM32H743xx system clock configuration file
  - USB_Device/HID_LPM_Standalone/Src/stm32h7xx_it.c          Interrupt handlers
  ...
  - USB_Device/HID_LPM_Standalone/Inc/stm32h7xx_it.h          Interrupt handlers header file
  - USB_Device/HID_LPM_Standalone/Inc/stm32h7xx_hal_conf.h    HAL configuration file
