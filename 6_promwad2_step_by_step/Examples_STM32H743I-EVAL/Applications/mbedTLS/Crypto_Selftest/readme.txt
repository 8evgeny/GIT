...
This application implements on STM32H753I-EVAL board a set of cryptographic features
...
In case of errors the red led (LED3) is toggling.
...
Inc
  ...
  - mbedTLS/Crypto_Selftest/Inc/exc7200_conf.h                EXC7200 TS component configuration file
  - mbedTLS/Crypto_Selftest/Inc/is42s32800g_conf.h            IS42S32800G SDRAM configuration file
  - mbedTLS/Crypto_Selftest/Inc/stmpe811_conf.h               STMPE811 IO expander component configuration file
  - mbedTLS/Crypto_Selftest/Inc/ts3510_conf.h                 TS3510 TS component configuration file
  - mbedTLS/Crypto_Selftest/Inc/stm32h743i_eval_conf.h        stm32h743i_eval configuration file
...
@par Hardware and Software environment
  - This example runs on STM32H753I devices.
  ...
  - STM32H753I-EVAL Set-up:
    - (optional) Connect a null-modem female/female RS232 cable between the DB9 connector
...
In order to make the program work, you must do the following:
 ...
 - Rebuild all files and load your image into target memory
    ...
    - Connect the STM32H753I-EVAL board to the PC through 'USB micro B-Male
