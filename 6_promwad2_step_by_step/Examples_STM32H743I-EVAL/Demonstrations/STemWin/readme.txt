/**
  ...
  * @brief   Description of STM32H743I-EVAL Demonstration
  ******************************************************************************
  * @attention
  *
...
The STM32 H7 STemWin demonstration is running on STM32H743I EVAL boards 
...
1- Open STM32CubeProgrammer V1.3.0 or later, click on "External Loader" from the bar menu then check 
   "MT25TL01G_STM32H7xxI-EVAL" box 
2- Connect the STM32H743I-EVAL board to PC with USB cable through CN23
3- Use "STM32CubeDemo_STM32H743I-EVAL_VX.Y.Z.hex" file provided under “Binary” with to program both internal Flash and external QSPI memory.
