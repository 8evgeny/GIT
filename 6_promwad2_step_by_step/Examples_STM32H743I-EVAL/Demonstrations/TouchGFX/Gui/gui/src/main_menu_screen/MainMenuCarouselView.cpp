...
void MainMenuCarouselView::setupScreen()
{
    ...
    demoHeadline.setPosition(90, 372, 450, 24);
    demoHeadline.setColor(Color::getColorFrom24BitRGB(0xFF, 0xFF, 0xFF));
    add(demoHeadline);

    demoText.setPosition(60, 402, 510, 60);
...
void MainMenuCarouselView::setupCarousel()
{
    ...
    carousel.addElement(Bitmap(BITMAP_CAROUSEL_MENU_ICONS_KNIGHT_SMALL_ID), Bitmap(BITMAP_CAROUSEL_MENU_ICONS_KNIGHT_MEDIUM_ID), Bitmap(BITMAP_CAROUSEL_MENU_ICONS_KNIGHT_LARGE_ID));
    ...
    carousel.addElement(Bitmap(BITMAP_CAROUSEL_MENU_ICONS_BUMP_MAP_SMALL_ID), Bitmap(BITMAP_CAROUSEL_MENU_ICONS_BUMP_MAP_MEDIUM_ID), Bitmap(BITMAP_CAROUSEL_MENU_ICONS_BUMP_MAP_LARGE_ID));
    ...
    demoIDs[3] = Defines::KNIGHT_GAME;
    headlines[3] = T_CAROUSEL_KNIGHT_HEADLINE;
    texts[3] = T_CAROUSEL_KNIGHT_TEXT;
    ...
    headlines[7] = T_CAROUSEL_BUMP_MAP_HEADLINE;
    texts[7] = T_CAROUSEL_BUMP_MAP_TEXT;
