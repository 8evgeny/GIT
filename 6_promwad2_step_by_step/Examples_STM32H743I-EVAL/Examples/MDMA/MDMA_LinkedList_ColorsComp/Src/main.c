...
{      
  ...
  UTIL_LCD_DisplayStringAt(40 , LCD_Y_Size - (IMAGE_HEIGHT/2) - 40 , (uint8_t *)"Red", LEFT_MODE); 
  
  UTIL_LCD_SetTextColor(UTIL_LCD_COLOR_GREEN);        
  UTIL_LCD_DisplayStringAt(80 + (IMAGE_WIDTH/2) , LCD_Y_Size - (IMAGE_HEIGHT/2) - 40, (uint8_t *)"Green", LEFT_MODE); 
  
  UTIL_LCD_SetTextColor(UTIL_LCD_COLOR_BLUE);        
  UTIL_LCD_DisplayStringAt(120 + IMAGE_WIDTH  , LCD_Y_Size - (IMAGE_HEIGHT/2) - 40, (uint8_t *)"Blue", LEFT_MODE);
}
/**
