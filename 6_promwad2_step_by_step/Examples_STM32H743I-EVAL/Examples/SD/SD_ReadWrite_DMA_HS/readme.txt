...
This example shows how to support UHS-I SD Card with a frequency of 116MHz.
It can achieve a frequency of 145MHz for some UHS-I SD Cards.
...
The transfer clock is set at 116MHz (SDMMC_CLK / Clock_DIV * 2) are configured within the 
