...
enumerated as a HID device using the native PC Host HID driver to which the NUCLEO-H723ZG
...
@par Hardware and Software environment
  ...
  - This application has been tested with STMicroelectronics NUCLEO-H723ZG board
