...
USB host application based on the Human Interface Class (HID) on the STM32H723XX devices.

This is a typical application on how to use the STM32H723ZGT6 USB OTG Host peripheral to interact with an USB
