...
The SystemClock_Config() function is called to configure the system clock for STM32H723xx Devices :
The CPU at 520 MHz.
...
NUCLEO-H723ZG LEDs are used to monitor the example status:
...
@par Directory contents 
  ...
  - CRC/CRC_Example/Inc/stm32h7xx_nucleo_conf.h    board configuration file  
...
@par Hardware and Software environment
  ...
  - This example has been tested with an STMicroelectronics NUCLEO-H723ZG
