...
@par Directory contents
  ...
  - HAL/HAL_TimeBase_RTC_ALARM/Inc/stm32h7xx_nucleo_conf.h             STM32H7xx_Nucleo board configuration file
  - HAL/HAL_TimeBase_RTC_ALARM/Src/stm32h7xx_it.c                     Interrupt handlers
  - HAL/HAL_TimeBase_RTC_ALARM/Src/main.c                             Main program
  - HAL/HAL_TimeBase_RTC_ALARM/Src/stm32h7xx_hal_timebase_rtc_alarm.c HAL time base rtc alarm functions
...
@par Hardware and Software environment
  ...
  - This example has been tested with STMicroelectronics NUCLEO-H723ZG board and can be
