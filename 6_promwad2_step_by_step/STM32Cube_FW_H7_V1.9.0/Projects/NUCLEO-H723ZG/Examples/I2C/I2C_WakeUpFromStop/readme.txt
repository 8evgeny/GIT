...
clock (SYSCLK) to run at 520 MHz. When The system is wakeup from Stop mode,
...
NUCLEO-H723ZG's LEDs can be used to monitor the transfer status on the Slave Board :
...
Connectivity, Communication, I2C, Stop Mode, WakeUp, Master, Slave, Transmission, Reception, Fast mode plus
...
@par Directory contents
  ...
  - I2C/I2C_WakeUpFromStop/Inc/stm32h7xx_nucleo_conf.h    HAL configuration file
  - I2C/I2C_WakeUpFromStop/Inc/i2c_timing_utility.h          Header of i2c_timing_utility.c
  - I2C/I2C_WakeUpFromStop/Src/i2c_timing_utility.c          Utility to calculate the I2C timing
