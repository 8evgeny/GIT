...
@note To measure the current consumption in Standby mode, remove jumper JP4
...
@par Directory contents
  ...
  - PWR/PWR_STANDBY_RTC/Inc/stm32h7xx_nucleo_conf.h   STM32H7xx_Nucleo board configuration file
