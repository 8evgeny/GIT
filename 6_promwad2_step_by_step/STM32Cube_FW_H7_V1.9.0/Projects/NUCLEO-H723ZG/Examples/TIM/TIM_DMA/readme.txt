...
The APB clock dividers for D1 Domain APB3 peripherals, D2 Domain APB1 and APB2 peripherals and D3 Domain APB4 peripherals to run at 520 MHz/4.
  ...
  The following configuration values are used in this example:
    ...
    - TIM1CLK = SystemCoreClock/2
    - Counter repetition = 3
    - Prescaler = 0
    - TIM1 counter clock = SystemCoreClock/2
    - SystemCoreClock is set to 520 MHz for STM32H7xx

  The objective is to configure TIM1 channel 3 to generate PWM
...
@note PWM signal frequency value mentioned above is theoretical (obtained when the system clock frequency
      is exactly 520 MHz). Since the generated system clock frequency may vary from one board to another, the observed
...
@par Directory contents
  ...
  - TIM/TIM_DMA/Inc/stm32h7xx_nucleo_conf.h  STM32H7xx_Nucleo board configuration file
