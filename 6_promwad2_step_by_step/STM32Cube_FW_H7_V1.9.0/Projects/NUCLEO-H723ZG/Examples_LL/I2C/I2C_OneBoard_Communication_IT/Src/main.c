...
void Configure_I2C_Slave(void)
{
  ...
  /* Timing register value is computed with the STM32CubeMX Tool,
    * Fast Mode @400kHz with I2CCLK = 520 MHz,
    * 
    * Timing Value = (uint32_t)
    */
  timing = __LL_I2C_CONVERT_TIMINGS(0x5, 0x3, 0x3, 0x3, 0x9);
...
/**
  ...
  *         -5- Enable I2C4.
  *         -6- Enable I2C4 transfer complete/error interrupts.
  * @note   Peripheral configuration is minimal configuration from reset values.
  *         Thus, some useless LL unitary functions calls below are provided as
  *         commented examples - setting is default configuration from reset.
  * @param  None
...
void Configure_I2C_Master(void)
{
  ...
  /* Disable I2C4 prior modifying configuration registers */
  LL_I2C_Disable(I2C4);
  ...
  /* Configure Digital Noise Filter */
  /* Reset Value is 0x00            */
  //LL_I2C_SetDigitalFilter(I2C4, 0x00);
