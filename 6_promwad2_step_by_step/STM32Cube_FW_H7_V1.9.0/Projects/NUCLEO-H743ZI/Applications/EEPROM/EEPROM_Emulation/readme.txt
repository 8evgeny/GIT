...
NUCLEO-H743ZI 's LEDs can be used to monitor the application status:
  - LED1 is ON when the application runs successfully.
  - LED2 is ON in case of error.
  - LED3 is Toggling when an operation of write and read is ongoing.
...
Table 1. EEPROM application implementation on NUCLEO-H743ZI
+------------+--------------------------------------------------------------+-----------------------+
