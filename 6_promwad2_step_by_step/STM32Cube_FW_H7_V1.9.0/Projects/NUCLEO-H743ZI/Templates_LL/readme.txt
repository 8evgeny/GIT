...
2. Replace source files of the LL template by the ones of the LL example, except
  ...
  running on NUCLEO-H743ZI board from STMicroelectronics.
...
@Note It is recommended to enable the cache and maintain its coherence, but depending
      on the use case. It is also possible to configure the MPU as "Write through",
      to guarantee the write access coherence.
...
@par Hardware and Software environment
  ...
  - This template has been tested with STMicroelectronics NUCLEO-H743ZI
