...
for test (located in main.h):
 - "WAVEFORM_VOLTAGE_GENERATION_FOR_TEST" defined: For this example purpose, generates a
   waveform voltage by DAC peripheral on a spare DAC channel: DAC_CHANNEL_1 on pin PA.04 (Morpho connector CN11 pin 32).
...
NUCLEO-H745ZI-Q board LEDs are used to monitor the program execution status:
