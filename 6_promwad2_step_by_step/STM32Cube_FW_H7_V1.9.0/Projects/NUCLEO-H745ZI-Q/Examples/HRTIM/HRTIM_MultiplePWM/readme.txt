...
This example shows how to configure the HRTIM1 peripheral to generate up to 5 PWM signals
with different duty cycle for each HRTIM output.
Each of the 5 slave Timers (TIMA to TIME) is configured to generate 5 PWM signal
...
since APB2 prescaler is equal to 2.
  ...
  => HRTIM1CLK = HCLK
    ...
    HRTIM1 TIMA TA1 duty cycle = (HRTIM_TIMA_PULSE1/ HRTIM1_TIMA_PER)* 100 = 15%
    HRTIM1 TIMB TB1 duty cycle = (HRTIM_TIMB_PULSE1/ HRTIM1_TIMB_PER)* 100 = 25%
    HRTIM1 TIMC TC1 duty cycle = (HRTIM_TIMC_PULSE1/ HRTIM1_TIMC_PER)* 100 = 40%
    HRTIM1 TIMD TD1 duty cycle = (HRTIM_TIMD_PULSE1/ HRTIM1_TIMD_PER)* 100 = 60%
    HRTIM1 TIME TE1 duty cycle = (HRTIM_TIME_PULSE1/ HRTIM1_TIME_PER)* 100 = 80%
...
@par Hardware and Software environment
  ...
  - This example has been tested with STM32H745I_NUCLEO  board with SMPS (SD Convertor) power supply config and can be
