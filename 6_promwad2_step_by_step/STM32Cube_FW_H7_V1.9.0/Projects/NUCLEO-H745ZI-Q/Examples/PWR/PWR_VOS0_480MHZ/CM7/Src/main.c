/**
  ******************************************************************************
  * @file    PWR/PWR_VOS0_480MHZ/CM7/Src/main.c
  * @author  MCD Application Team
  * @brief   This example describes how to switch to VOS0 PWR scale 
  *          with 480MHz system clock.
...
#else
  #error "Please make sure that the NUCLEO-H745ZI-Q Board has been modified to match the LDO configuration then set the define BOARD_HW_CONFIG_IS_LDO to 1 and BOARD_HW_CONFIG_IS_DIRECT_SMPS set to 0 to confirm the HW config"
...
#else
  #error "Please make sure that the NUCLEO-H745ZI-Q Board has been modified to match the Direct SMPS configuration then set the define BOARD_HW_CONFIG_IS_LDO to 0 and BOARD_HW_CONFIG_IS_DIRECT_SMPS set to 1 to confirm the HW config"
...
/**
  ...
  *            HCLK(Hz)                       = 240000000 (Cortex-M4 CPU, Bus matrix Clocks)
  *            AHB Prescaler                  = 2
