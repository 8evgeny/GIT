...
@par Hardware and Software environment
  ...
  - This example has been tested with NUCLEO-H745ZI-Q board with SMPS (SD Converter) power supply  config and can be easily tailored to any other supported device and development board.
