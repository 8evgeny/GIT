...
2. Replace source files of the LL template by the ones of the LL example, except
  ...
  running on NUCLEO-H745ZI-Q board from STMicroelectronics.
...
System, LL template, multiprocessor, Clock Configuration, HSE bypass mode,System clock, Oscillator, PLL
...
@par Hardware and Software environment
  ...
  - This template has been tested with STMicroelectronics NUCLEO-H745ZI-Q
