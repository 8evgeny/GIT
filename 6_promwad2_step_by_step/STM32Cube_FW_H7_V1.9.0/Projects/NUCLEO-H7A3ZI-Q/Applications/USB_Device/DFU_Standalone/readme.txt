...
In this application, two operating modes are available:
 ...
 2. Run-time application mode:
    This is the normal run-time activities. A binary which toggles LEDs on the NUCLEO-H7A3ZI-Q board is
    provided in Binary directory.

@note After each device reset (unplug the NUCLEO-H7A3ZI-Q board from PC), Plug the NUCLEO-H7A3ZI-Q board with Key User push-button button
...
@note A binary which toggles LEDs on the NUCLEO-H7A3ZI-Q board is provided in Binary directory.
...
In order to make the program work, you must do the following:
  ...
  * With "DfuSe Demonstrator":
   ...
   - Open "DfuSe Demo", choose the "NUCLEO-H7A3ZI-Q_LED_Toggle@0x0800C000.dfu" provided in Binary
  ...
  * With "STM32CubeProgrammer":
   ...
   - Download the "NUCLEO-H7A3ZI-Q_LED_Toggle@0x0800C000.bin" provided in Binary directory and set the start address.
