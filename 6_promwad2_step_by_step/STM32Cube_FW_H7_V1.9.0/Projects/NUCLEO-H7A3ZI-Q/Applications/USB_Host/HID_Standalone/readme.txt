...
USB host application based on the Human Interface Class (HID) on the STM32H7A3ZI-Q devices.

This is a typical application on how to use the STM32H7A3ZI-Q USB OTG Host peripheral to interact with an USB
HID Device such as a Mouse or a Keyboard.

At the beginning of the main program the HAL_Init() function is called to reset
all the peripherals, initialize the Flash interface and the systick.
The SystemClock_Config() function is used to configure the system clock for STM32H7A3ZI-Q Devices :
The CPU at 280MHz
...
@par Directory contents
  ...
  - USB_Host/HID_Standalone/Core/Inc/stm32h7xx_nucleo_conf.h  Hardware configuration File
...
@par Hardware and Software environment
  ...
  - This application runs on STM32H7A3ZI-Q devices.
  ...
  - NUCLEO-H7A3ZI-Q Set-up
    - Plug the USB key into the NUCLEO-H7A3ZI-Q board through 'USB micro A-Male
