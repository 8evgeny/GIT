...
This is a typical application on how to use the STM32H7A3ZI-Q USB OTG Host peripheral to operate with an USB
...
@par Directory contents
   ...
   - USB_Host/MSC_Standalone/Core/Src/system_stm32h7xx.c           STM32H7xx system clock configuration file
