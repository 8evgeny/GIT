...
#define ADCy_CHANNELa                   ADC_CHANNEL_13

/* Definition of ADCy channels pins */
#define ADCy_CHANNELa_GPIO_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE()
...
#define DACx_CHANNEL_TO_ADCx_CHANNELa_DMA_CLK_ENABLE()           __HAL_RCC_DMA1_CLK_ENABLE()
#define DACx_CHANNEL_TO_ADCx_CHANNELa_DMA                        DMA1_Stream3
#define DACx_CHANNEL_TO_ADCx_CHANNELa_DMA_IRQn                   DMA1_Stream3_IRQn
#define DACx_CHANNEL_TO_ADCx_CHANNELa_DMA_IRQHandler             DMA1_Stream3_IRQHandler
