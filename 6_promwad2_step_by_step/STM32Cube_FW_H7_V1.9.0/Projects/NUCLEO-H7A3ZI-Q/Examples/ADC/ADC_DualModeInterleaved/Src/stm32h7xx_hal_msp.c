...
void HAL_DAC_MspInit(DAC_HandleTypeDef *hdac)
{
  ...
  /* Enable clock of DMA associated to the peripheral */
  DACx_CHANNEL_TO_ADCx_CHANNELa_DMA_CLK_ENABLE();
 ...
 HAL_GPIO_Init(DACx_CHANNEL_TO_ADCx_CHANNELa_GPIO_PORT, &GPIO_InitStruct);
  ...
  DmaHandle.Instance = DACx_CHANNEL_TO_ADCx_CHANNELa_DMA;
  ...
  if (DmaHandle.Instance == DACx_CHANNEL_TO_ADCx_CHANNELa_DMA)
  {
  ...
  /* NVIC configuration for DMA interrupt (transfer completion or error) */
  /* Priority: high-priority */
  HAL_NVIC_SetPriority(DACx_CHANNEL_TO_ADCx_CHANNELa_DMA_IRQn, 1, 0);
  HAL_NVIC_EnableIRQ(DACx_CHANNEL_TO_ADCx_CHANNELa_DMA_IRQn);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef *hdac)
{
 ...
 HAL_GPIO_DeInit(DACx_CHANNEL_TO_ADCx_CHANNELa_GPIO_PORT, DACx_CHANNEL_TO_ADCx_CHANNELa_PIN);
  ...
  /*##-4- Disable the NVIC ###################################################*/
  /* Disable the NVIC configuration for DMA interrupt */
  HAL_NVIC_DisableIRQ(DACx_CHANNEL_TO_ADCx_CHANNELa_DMA_IRQn);
