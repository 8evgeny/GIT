...
for test (located in main.h):
 - "WAVEFORM_VOLTAGE_GENERATION_FOR_TEST" defined: For this example purpose, generates a
   ...
   If ADC channel and DAC channel are selected on two different GPIO (default configuration in this example):
...
Board settings:
  ADC1 and ADC2 are configured to convert the same channel: ADC_CHANNEL_13 on pin PC.03 (Arduino connector CN9 pin 5, Morpho connector CN11 pin 37).
...
@par Directory contents 
  ...
  - ADC/ADC_DualModeInterleaved/Inc/stm32h7xx_nucleo_conf.h    HAL configuration file  
