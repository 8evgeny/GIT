...
NUCLEO-H7A3ZI-Q LEDs are used to monitor the example status:
...
@par Directory contents 
  ...
  - CRC/CRC_Example/Inc/stm32h7xx_nucleo_conf.h    HAL configuration file  
...
@par Hardware and Software environment
  ...
  - This example has been tested with an STMicroelectronics NUCLEO-H7A3ZI-Q
