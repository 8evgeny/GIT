...
The DAC peripheral is used to perform a simple conversion in 8 bits right alignment of 0xFF value in normal mode
then in low power mode (stop mode), the result of the conversion can be seen by connecting PA6 (DAC channel1) to an oscilloscope.
The observed value is 3.3V.
      

NUCLEO-H7A3ZI-Q board's LEDs can be used to monitor the process status:
...
@par Directory contents 
  ...
  - DAC/DAC_Simple_Conversion/Inc/stm32h7xx_nucleo_conf.h  STM32H7xx_Nucleo board configuration file
...
@par Hardware and Software environment  
  ...
  - NUCLEO-H7A3ZI-Q Set-up
      ...
      - Connect PA6 (DAC Channel1) on nucleo board connector (pin 12 in CN7) to an oscilloscope and use User Button to move from normal mode to low power mode.
