...
write protection status of FLASH_WRP_SECTORS (defined in main.c)
  - If FLASH_WRP_SECTORS are write protected, the write protection will be disabled.
    ...
    Otherwise, LED1 turns On and LED2 turns Off to indicate that Write protection is correctly disabled.
  ...
  - If FLASH_WRP_SECTORS are not write protected, the write protection will be enabled.
    ...
    remain toggling each 100ms.
    Otherwise, LED1 turns Off and LED2 turns On to indicate that Write protection is correctly enabled.
...
@par Directory contents 
  ...
  - FLASH/FLASH_WriteProtection/Inc/stm32h7xx_nucleo_conf.h      STM32H7xx_Nucleo board configuration file
