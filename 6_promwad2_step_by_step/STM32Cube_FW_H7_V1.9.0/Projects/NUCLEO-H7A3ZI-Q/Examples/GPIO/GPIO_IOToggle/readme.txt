...
PB.00 and PE.01 IOs (configured in output pushpull mode) toggle in a forever loop.
On NUCLEO-H7A3ZI-Q board these IOs are connected to LED1 and LED2.
...
@par Directory contents 
  ...
  - GPIO/GPIO_IOToggle/Inc/stm32h7xx_nucleo_conf.h  STM32H7xx_Nucleo board configuration file
