...
When The system is wakeup from Stop mode, system clock is 64 Mhz.
The I2C peripheral is directly clocked by HSI.
...
NUCLEO-H7A3ZI-Q's LEDs can be used to monitor the transfer status on the Slave Board :
