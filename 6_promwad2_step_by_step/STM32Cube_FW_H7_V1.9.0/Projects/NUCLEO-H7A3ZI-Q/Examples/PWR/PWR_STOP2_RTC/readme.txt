...
@note To measure the current consumption in Stop 2 mode, remove JP4 jumper 
...
@par Directory contents 
  ...
  - PWR/PWR_STOP2_RTC/Inc/stm32h7xx_nucleo_conf.h  STM32H7xx_Nucleo board configuration file
...
@par Hardware and Software environment
  ...
  - NUCLEO-H7A3ZI-Q Set-up
    - Use LED1 and LED3 connected respectively to PB.00 and PB.14 pins
