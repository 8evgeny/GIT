...
How to configure RTC to write/read data to/from RTC Backup registers and to demonstrate 
...
3. When applying a high level on the time stamp pin (PC.13) by pressing the User push-button,
...
@par Directory contents 
  ...
  - RTC/RTC_Tamper/Inc/stm32h7xx_nucleo_conf.h STM32H7xx board configuration file 
