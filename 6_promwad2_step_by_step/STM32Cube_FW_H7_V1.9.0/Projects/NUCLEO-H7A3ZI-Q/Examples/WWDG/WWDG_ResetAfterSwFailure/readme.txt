...
The WWDG timeout is set, through counter value, to 480 ms. 
The refresh window is set in order to make user wait 180 ms after a wadchdog refresh, 
before writing again counter. Hence the WWDG counter is refreshed each (180 + 1) ms in the 
...
@par Directory contents 
  ...
  - WWDG/WWDG_ResetAfterSwFailure/Inc/stm32h7xx_nucleo_conf.h STM32H7xx board configuration file
