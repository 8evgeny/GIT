...
Different configuration will be observed
 ...
 - PLLCLK frequency value divided by 4, hence around @70MHz.
 - SYSCLK frequency value divided by 2, hence around @140MHz.
...
@par Hardware and Software environment
  ...
  - NUCLEO-H7A3ZI-Q Set-up
    - Connect the MCO pin to an oscilloscope to monitor the different waveforms:
      - PA.08: connected to pin 23 of CN12 morpho connector or pin 4 of CN10 (SB28 fitted) arduino connector for Nucleo-144 (MB1364)
      - PC.09: connected to pin 1 of CN12 morpho connector (SB9 fitted) or pin 4 of CN8 arduino connector for Nucleo-144 (MB1364)
