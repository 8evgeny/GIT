/**
  ...
  *          SRAM memory through the STM32H7xx DMA HAL and LL API.
  ******************************************************************************
  * @attention
  *
...
static void DMA_Config(void)
{
  ...
  /*##-3- Select the DMA instance to be used for the transfer : DMA1_Stream1 #*/
  ...
  /* - __LL_DMA_GET_INSTANCE() to convert DMA1_Stream1 into DMA1           */
  /* - __LL_DMA_GET_STREAM() to convert DMA1_Stream1 into LL_DMA_STREAM_1  */
