...
NUCLEO-H7A3ZI-Q board's LEDs can be used to monitor the transfer status:
...
Display, Graphics, DMA2D, LCD, SRAM, Memory to memory, RGB565, Adafruit, TFT
...
@par Directory contents 
  ...
  - DMA2D/DMA2D_MemToMemWithLCD/Inc/stm32h7xx_nucleo_conf.h    STM32H7xx_Nucleo board configuration file
