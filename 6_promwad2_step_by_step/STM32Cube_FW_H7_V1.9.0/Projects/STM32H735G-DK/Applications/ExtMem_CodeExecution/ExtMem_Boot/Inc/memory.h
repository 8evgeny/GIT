  ...
  ==============================================================================
    [..]
      ...
      (#) CODE_AREA: Used to specify external memory used for code execution
         ...
         (##) BootROM Mode:
             (+++) USE_EXTERNAL_RAM   : External OSPI RAM is used for code execution
...
#elif (CODE_AREA == USE_EXTERNAL_RAM)
  #define APPLICATION_ADDRESS            OCTOSPI2_BASE

#elif (CODE_AREA == USE_INTERNAL_SRAM)
  #define APPLICATION_ADDRESS            0x24000000U
