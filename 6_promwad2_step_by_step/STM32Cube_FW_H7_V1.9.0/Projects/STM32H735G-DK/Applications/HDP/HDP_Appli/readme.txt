...
This code example shows how to set, use and remove a single secure area.
...
HDP_Appli code is executed starting at Flash address 0x08040000 corresponding to the second flash area.

@note The STLogo is stored in the second flash area.
The same image is now stored twice, one in the first and one in the second flash area.

The STlogo stored in the first flash area will be displayed as a black box after setting secure area using Cubeprogrammer:
...
@par Directory contents
  ...
  - HDP/HDP_Appli/Inc/mx25lm51245g_conf.h                               MX25LM51245G OSPI FLASH memory configuration file
  - HDP/HDP_Appli/Inc/stm32h7xx_hal_conf.h                             HAL configuration file
  - HDP/HDP_Appli/Inc/stm32h735g_discovery_conf.h                        board configuration file
  ...
  - HDP/HDP_Appli/Inc/s70kl1281_conf.h                                 S70KL1281DABHI023 OctoSPI RAM memory configuration file
  - HDP/HDP_Appli/Inc/RSS.h                                            RSS public interface file
  - HDP/HDP_Appli/Inc/stlogo.h                                         ST Log BMP image 
  - HDP/HDP_Appli/Src/stm32h7xx_it.c                                   Interrupt handlers
  - HDP/HDP_Appli/Src/main.c                                           Main program
  - HDP/HDP_Appli/Src/system_stm32h7xx.c                               STM32H7xx system source file
