...
How to use the libjpeg API to encode and decode a BMP image into a jpeg file.
...
Then a BMP file is read form th micro SD, encoded into a jpeg file that is saved in the SD card root then decoded and displayed on the LCD.
...
in case of wrong color display, Red/blue swapped, uncomment "SWAP_RB" in the main.h to fix the issue.

On success the green led is toggling.
In cas of errors the red led is toggling.

@note The BMP images, with 320x240 size, should be copied at the micro SD card root
      customize the "BMP_IMAGE_FILE" and "JPEG_IMAGE_FILE" defines in the main.h
      to point to the actual files names.
...
@par Directory contents
    ...
    - LibJPEG/LibJPEG_Encoding/Inc/stm32h7xx_it.h               Interrupt handlers header file
    - LibJPEG/LibJPEG_Encoding/Inc/stm32h7xx_hal_conf.h         HAL Configuration file
    ...
    - LibJPEG/LibJPEG_Encoding/Src/encode.h                     encoder header file
    ...
    - LibJPEG/LibJPEG_Encoding/Inc/sd_diskio.h                  the FatFs sd diskio header file
    ...
    - LibJPEG/LibJPEG_Encoding/Src/stm32h7xx_it.c               Interrupt handlers
    - LibJPEG/LibJPEG_Encoding/Src/system_stm32h7xx.c           stm32h7xx system clock configuration file
    ...
    - LibJPEG/LibJPEG_Encoding/Inc/sd_diskio.c                  the FatFs sd diskio implementation
