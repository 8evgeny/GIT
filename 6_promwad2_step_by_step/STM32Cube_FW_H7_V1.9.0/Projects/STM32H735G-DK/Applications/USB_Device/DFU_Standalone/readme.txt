...
In this application, two operating modes are available:
 ...
 2. Run-time application mode:
    This is the normal run-time activities. A binary which toggles LED1 and LED2 on the STM32H735G-DK board is
    provided in Binary directory.

@note After each device reset (unplug the STM32H735G-DK board from PC), Plug the STM32H735G-DK board with Key User Button button
...
@note A binary HID_Standalone on the STM32H735G-DK board is provided in Binary directory.
...
@par Hardware and Software environment
  ...
  - STM32H735G-DK board Set-up
    ...
    - Connect the STM32H735G-DK board to the PC.
    - Connect the STM32H735G-DK board to the PC through micro A-Male to standard A Male cable connected to the connector.
...
In order to make the program work, you must do the following:
 ...
 - To run the application, proceed as follows:
   ...
   * With "DfuSe Demonstrator":
    ...
    - Open "DfuSe Demo", choose the "STM32H735G-DK_LED_Toggle@0x08020000.dfu" provided in Binary
   ...
   * With "STM32CubeProgrammer":
    ...
    - Download the "STM32H735G-DK_LED_Toggle@0x08020000.bin" provided in Binary directory and set the start address.
