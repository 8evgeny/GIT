...
enumerated as a HID device using the native PC Host HID driver to which the STM32H735G-DK
...
@par Hardware and Software environment
  ...
  - This application has been tested with STMicroelectronics STM32H735G-DK board
