...
USB host application based on the Human Interface Class (HID) on the STM32H735XX devices.

This is a typical application on how to use the STM32H735XX USB OTG Host peripheral to interact with an USB
...
@par Directory contents
  ...
  - USB_Host/HID_Standalone/Core/Inc/stm32h735g_discovery_conf.h    Hardware configuration File
