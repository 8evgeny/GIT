...
USB host application based on the Mass Storage Class (MSC) on the STM32H735XX devices.

This is a typical application on how to use the STM32H735XX USB OTG Host peripheral to operate with an USB
...
@par Directory contents
   ...
   - USB_Host/MSC_Standalone/Core/Src/system_stm32h7xx.c           STM32H735XX system clock configuration file
   ...
   - USB_Host/MSC_Standalone/Core/Inc/stm32h735g_discovery_conf.h  Hardware configuration File
...
@par Hardware and Software environment
  ...
  - STM32H735G-DK Set-up
    - Plug the USB key into the STM32H735G-DK board through 'USB micro A-Male
