...
WasherContainer::WasherContainer() :
    ...
    paused(false), touchTimer(0), currentProgram(0), washingTime(0)
{
...
void WasherContainer::setProgramTextAndTime(int16_t item)
{
    ...
    washingTime = totalTime;
    Unicode::snprintf(textAreaProgramLengthBuffer, TEXTAREAPROGRAMLENGTH_SIZE, "%d:%02d", totalTime / 60, totalTime % 60);
}
