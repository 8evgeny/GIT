...
In this example, the comparator input is connected on the pin PE.09.
...
@par Directory contents
  ...
  - COMP/COMP_Interrupt/Inc/stm32h735g_discovery_conf.h    HAL configuration file
...
@par Hardware and Software environment
  ...
  - STM32H735G-DK Set-up
    ...
    - Use RED LED2 connected to PC2 pin
    - Apply an external variable voltage on PE.09 (connected on pin 18 on STMOD+) with average voltage 1.22V.
