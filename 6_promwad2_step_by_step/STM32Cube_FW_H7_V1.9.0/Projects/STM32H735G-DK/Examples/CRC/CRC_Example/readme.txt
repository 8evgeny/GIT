...
and compared with the expected one stored in uwExpectedCRCValue variable.
  ...
  - LED2 (RED) is ON when an incorrect CRC value is calculated or when there is an initialization error.
...
@par Directory contents 
  ...
  - CRC/CRC_Example/Inc/stm32h735g_discovery_conf.h    board configuration file  
...
@par Hardware and Software environment
  ...
  - This example has been tested with an STMicroelectronics STM32H735G-DK
