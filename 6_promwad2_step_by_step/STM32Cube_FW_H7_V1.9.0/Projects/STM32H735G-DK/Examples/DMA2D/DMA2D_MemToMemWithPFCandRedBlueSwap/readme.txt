...
STM32H735G-DK board's LEDs can be used to monitor the transfer status:
  ...
  - LED2 is On when there are errors in LTDC Init process or in DMA2D transfer
...
@par Directory contents
    ...
    - DMA2D/DMA2D_MemToMemWithPFCandRedBlueSwap/Inc/stm32h735g_discovery_conf.h  STM32H735G-DK board configuration file
    - DMA2D/DMA2D_MemToMemWithPFCandRedBlueSwap/Inc/ft5336_conf.h         FT5336 capacitive touch panel configuration file
    - DMA2D/DMA2D_MemToMemWithPFCandRedBlueSwap/Inc/s70kl1281_conf.h      S70KL1281DABHI023 OctoSPI RAM memory configuration file
    - DMA2D/DMA2D_MemToMemWithPFCandRedBlueSwap/Inc/mx25lm51245g_conf.h   MX25LM51245G OSPI FLASH memory configuration file
