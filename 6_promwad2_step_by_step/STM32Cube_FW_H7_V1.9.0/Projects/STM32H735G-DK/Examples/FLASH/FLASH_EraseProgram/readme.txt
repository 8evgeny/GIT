...
The STM32H735G-DK board LEDs can be used to monitor the transfer status:
...
@par Directory contents
  ...
  - FLASH/FLASH_EraseProgram/Inc/stm32h735g_discovery_conf.h      STM32H735G-DK board configuration file
