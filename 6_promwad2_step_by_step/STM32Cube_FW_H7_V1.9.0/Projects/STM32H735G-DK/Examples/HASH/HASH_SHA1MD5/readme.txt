...
Red LED (LED2) is turned ON when an incorrect digest value is calculated or when there is an initialization error.
...
@par Directory contents 
  ...
  - HASH/HASH_SHA1MD5/Inc/stm32h735g_discovery_conf.h  STM32H735G-DK board configuration file
