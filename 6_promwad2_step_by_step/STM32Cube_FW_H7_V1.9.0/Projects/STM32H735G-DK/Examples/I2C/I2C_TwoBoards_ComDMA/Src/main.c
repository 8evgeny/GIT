...
__attribute__((section (".RAM_D3"))) uint8_t aTxBuffer[] = " **** I2C_TwoBoards communication based on DMA ****    **** I2C_TwoBoards communication based on DMA ****    **** I2C_TwoBoards communication based on DMA **** ";
...
#elif defined ( __CC_ARM )
__attribute__((section (".RAM_D3")))  uint8_t aRxBuffer[RXBUFFERSIZE];
#elif defined ( __GNUC__ )
__attribute__((section (".RAM_D3")))  uint8_t aRxBuffer[RXBUFFERSIZE];
#endif
