...
STM32H735G-DK board's LED can be used to monitor the transfer status:
...
@par Directory contents
    ...
    - LTDC/LTDC_Display_2Layers/Inc/stm32h735g_discovery_conf.h  STM32H735G-DK board configuration file
