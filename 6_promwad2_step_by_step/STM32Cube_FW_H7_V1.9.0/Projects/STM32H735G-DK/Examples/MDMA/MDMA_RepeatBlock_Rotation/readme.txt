/**
  @page MDMA_RepeatBlock_Rotation MDMA Repeat BLock Transfer Rotation example
...
@par Example Description
 ...
 - config 4 :
   ...
   STM32H735G-DK's  LED can be used to monitor the transfer status:
...
@par Directory contents
    ...
    - MDMA/MDMA_Repeat_BLock/Inc/stm32h735g_discovery_conf.h  STM32H735G-DK board configuration file
