/**
  ******************************************************************************
  * @file    OTFDEC/OTFDEC_Executing_Crypted_Instruction/Src/stm32h7xx_hal_msp.c
...
/**
* @brief  OTFDEC Msp Init
* @param  hcryp : OTFDEC Region handle
* @retval None
*/
...
/**
* @brief  OTFDEC Msp DeInit
* @param  hotfd : OTFDEC Region handle
* @retval None
*/
void HAL_OTFDEC_MspDeInit(OTFDEC_HandleTypeDef *hotfdec)
{
    /* Disable OTFDEC1 clock */
