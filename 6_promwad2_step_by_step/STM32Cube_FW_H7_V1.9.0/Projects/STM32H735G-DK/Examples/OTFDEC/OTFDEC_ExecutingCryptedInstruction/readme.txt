...
This example shows how to use OTFDEC to decrypt and execute instruction stored in external NOR flash.
...
Security, Cryptography, OTFDEC, OCTOSPI, OSPI, CRYP, Cypher, external flash, execute instruction, decryption

@par Directory contents

  - OTFDEC/OTFDEC_ExecutingCryptedInstruction/Src/main.c                        Main program
  - OTFDEC/OTFDEC_ExecutingCryptedInstruction/Src/stm32h7xx_it.c                Interrupt handlers
  - OTFDEC/OTFDEC_ExecutingCryptedInstruction/Src/stm32h7xx_hal_msp.c           HAL MSP module
  - OTFDEC/OTFDEC_ExecutingCryptedInstruction/Src/system_stm32h7xx.c             STM32H7xx system clock configuration file
  - OTFDEC/OTFDEC_ExecutingCryptedInstruction/Inc/main.h                        Main program header file
  - OTFDEC/OTFDEC_ExecutingCryptedInstruction/Inc/stm32h7xx_hal_conf.h          HAL Configuration file
  - OTFDEC/OTFDEC_ExecutingCryptedInstruction/Inc/stm32h7xx_it.h                Interrupt handlers header file
  - OTFDEC/OTFDEC_ExecutingCryptedInstruction/Inc/stm32h735g_discovery_conf.h   STM32H735G_DK board configuration file
