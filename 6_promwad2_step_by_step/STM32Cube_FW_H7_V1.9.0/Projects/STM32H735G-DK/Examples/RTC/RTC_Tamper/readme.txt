...
3. When applying a high level on the time stamp pin (PC.13) by pressing the User Button,
...
@par Directory contents 
  ...
  - RTC/RTC_Tamper/Inc/stm32h735g_discovery_conf.h STM32H7xx board configuration file 
