...
2. Replace source files of the LL template by the ones of the LL example, except
  ...
  This projects is configured for STM32H735xx devices using STM32CubeH7 HAL and
  running on the STM32H735G-DK board from STMicroelectronics.

  At the beginning of the main program the SystemClock_Config()function is called
  to configure the system clock for STM32H735xx Devices :
        - The CPU at 520 MHz
...
@par Hardware and Software environment
  ...
  - This template runs on STM32H735xx devices.

  - This template has been tested with STMicroelectronics STM32H735G-DK
