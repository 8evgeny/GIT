/**
  ******************************************************************************
  * @file    FatFs/FatFs_SDRAMDisk/Src/main.c
  * @author  MCD Application Team
  * @brief   This sample code shows how to use FatFs with SDRAM disk io drive.
  ******************************************************************************
  * @attention
  *
...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
FATFS SDRAMFatFs;  /* File system object for SDRAM logical drive */
FIL MyFile;     /* File object */
char SDRAMPath[4]; /* SD card logical drive path */
...
int main(void)
{
  ...
  */
  ...
  /*
   ...
   - The BSP_SDRAM_Init() is called in the SDRAMDISK_Driver Initialize()
   */
