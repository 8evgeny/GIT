...
use USB device application based on the Custom HID Class on the STM32H743xx devices.

This is a typical application on how to use the STM32H743xx USB OTG Device peripheral, where the STM32 MCU is 
enumerated as a HID compliant device using the native PC Host HID driver to which the STM32H743I-EVAL
board is connected.
...
@par Directory contents
  ...
  - USB_Device/CustomHID_Standalone/Src/system_stm32h7xx.c      STM32h7xx system clock configuration file
  - USB_Device/CustomHID_Standalone/Src/stm32h7xx_it.c          Interrupt handlers
  - USB_Device/CustomHID_Standalone/Src/stm32h7xx_hal_msp.c     HAL MSP module
  ...
  - USB_Device/CustomHID_Standalone/Inc/stm32h7xx_it.h          Interrupt handlers header file
  - USB_Device/CustomHID_Standalone/Inc/stm32hxx_hal_conf.h     HAL configuration file
