...
@par Directory contents
  ...
  - USB_Device/DFU_Standalone/Src/system_stm32h7xx.c      STM32H7xx system clock configuration file
  - USB_Device/DFU_Standalone/Src/stm32h7xx_it.c          Interrupt handlers
  ...
  - USB_Device/DFU_Standalone/Inc/stm32h7xx_it.h          Interrupt handlers header file
  - USB_Device/DFU_Standalone/Inc/stm32h7xx_hal_conf.h    HAL configuration file
...
In order to make the program work, you must do the following :
 ...
 - To run the application, proceed as follows:
   ...
   * With "DfuSe Demonstrator":
    ...
    - Open "DfuSe Demo" and download the "STM32H743I-EVAL_USBD_0x08020000.dfu" provided in Binary directory.
   ...
   * With "STM32CubeProgrammer":
    ...
    - Download the "STM32H743I-EVAL_USBD_0x08020000.bin" provided in Binary directory and set the start address.
