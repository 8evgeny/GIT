...
public:
    ...
    void coverWidgetTouched(const CoverWidget&, const ClickEvent&);
    void playButtonFadeEnded(const FadeAnimator<ClickListener<Button> >&);
...
private:
    ...
    Callback<AudioPlayerView, const CoverWidget&, const ClickEvent&> coverImageTouchedCallback;
    Callback<AudioPlayerView, const FadeAnimator<ClickListener<Button> >&> playButtonFadeEndedCallback;
    ...
    void setView(enum CoverWidget::COVER_VIEW view);
    ...
    static const int BLUR_REGION_WIDTH = 160; // 200;
    ...
    ClickListener<CoverWidget> coverImage;
    FadeAnimator<ClickListener<Button> > playButton;
    Button prevButton;
    Button nextButton;
    Button backButton;
