          ...
          { 
            ...
            {  
              AUDIOPLAYER_NotifyEndOfFile();
                ...
                int16_t *samples = (int16_t *)&haudio.buff[AUDIO_OUT_BUFFER_SIZE / 2];
                for (int i = 0; i < 64; i++) {
                    int sample = ((*samples + 32768) >> 9); /* 0, 128 */
          ...
          { 
            ...
            { 
              AUDIOPLAYER_NotifyEndOfFile();                     
                ...
                int16_t *samples = (int16_t *)&haudio.buff[0];
                for (int i = 0; i < 64; i++) {
                    int sample = ((*samples + 32768) >> 9); /* 0, 128 */
                    visualization_samples[i] = (uint8_t)sample;
                    samples += 2;
