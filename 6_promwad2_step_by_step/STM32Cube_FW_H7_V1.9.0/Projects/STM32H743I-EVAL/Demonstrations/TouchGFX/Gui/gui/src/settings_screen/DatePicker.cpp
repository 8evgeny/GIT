    ...
    onSelectedElementChanged(this, &DatePicker::selectedElementChangedHandler)
{
    ...
    years.setup(BITMAP_DATE_PICKER_BAR_ID, 204 - 75, 172, 56, 2, -366, 59);
    ...
    // a negative x value is used to place the overlay correctly inside the wheel
    days.setup(BITMAP_DATE_PICKER_BAR_ID, 103 - 50, 172, 56, 2, -240, 59);
    for (int i = 1; i < 32; i++)
    {
    ...
    // a negative x value is used to place the overlay correctly inside the wheel
    months.setup(BITMAP_DATE_PICKER_BAR_ID, 203 - 25, 172, 56, 2, -14, 59);
