...
@note This example works with UHS-I SD Card only (Ultra High speed cards)
...
@par Hardware and Software environment
  ...
  - A UHS-I (Ultra High Speed) SD  card is need to be plugged to the CN13 connector in Eval Board.
