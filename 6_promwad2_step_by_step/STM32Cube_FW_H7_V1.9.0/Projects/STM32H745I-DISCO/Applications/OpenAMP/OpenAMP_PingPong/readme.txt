...
In this application:
    ...
    - after reaching 100 exchanged messages, the LED1 is toggling
...
@par Directory contents
    ...
    - OpenAMP/OpenAMP_PingPong/Common/Src/mailbox_hsem.c        Mailbox configuration for OpenAMP MW
    ...
    - OpenAMP/OpenAMP_PingPong/Common/Inc/mailbox_hsem_if.h     Mailbox configuration for OpenAMP header file
