...
This is a typical application on how to use the STM32H745xx USB OTG Device peripheral where the STM32 MCU is
enumerated as a HID device using the native PC Host HID driver to which the STM32H745I-DISCO
...
In order to make the program work, you must do the following :
 ...
 - In the workspace toolbar select the project configuration:
   - STM32H745I-DISCO_USBH-FS: to configure the project for STM32H745xx devices using USB OTG FS peripheral
 - Run the application
