/**
  ******************************************************************************
  * @file    BSP/Common/Src/system_stm32h7xx.c
...
#else
#ifdef CORE_MARK
  SCB->VTOR = 0x08100000 | VECT_TAB_OFFSET; /* Vector Table Relocation in Internal FLASH */  
#else
...
#elif CORE_MARK
  SCB->VTOR = 0x08040000 | VECT_TAB_OFFSET;       /* Vector Table Relocation in Internal FLASH */
#else
  SCB->VTOR = 0x08120000 | VECT_TAB_OFFSET;       /* Vector Table Relocation in Internal FLASH */
#endif
#endif  
