...
CPU1 (Cortex-M7) will configure the DAC peripheral for each press on Tamper push-button, A signal has been
selected and can be monitored on the DAC channel one:
...
STM32H745I-DISCO board's LEDs can be used to monitor the process status:
...
@par Directory contents 
  ...
  - DAC/DAC_SignalsGeneration/CM7/Src/main.c                 Main program for Cortex-M7
  - DAC/DAC_SignalsGeneration/CM7/Src/stm32h7xx_it.c         Interrupt handlers for Cortex-M7
  - DAC/DAC_SignalsGeneration/CM7/Src/stm32h7xx_hal_msp.c    HAL MSP module for Cortex-M7
  - DAC/DAC_SignalsGeneration/CM7/Inc/main.h                 Main program header file for Cortex-M7  
  - DAC/DAC_SignalsGeneration/CM7/Inc/stm32h7xx_hal_conf.h   HAL Configuration file for Cortex-M7
  - DAC/DAC_SignalsGeneration/CM7/Inc/stm32h7xx_it.h         Interrupt handlers header file for Cortex-M7

  - DAC/DAC_SignalsGeneration/CM4/Src/main.c                 Main program for Cortex-M4
  - DAC/DAC_SignalsGeneration/CM4/Src/stm32h7xx_it.c         Interrupt handlers for Cortex-M4
  - DAC/DAC_SignalsGeneration/CM4/Src/stm32h7xx_hal_msp.c    HAL MSP module for Cortex-M4
  - DAC/DAC_SignalsGeneration/CM4/Inc/main.h                 Main program header file for Cortex-M4  
  - DAC/DAC_SignalsGeneration/CM4/Inc/stm32h7xx_hal_conf.h   HAL Configuration file for Cortex-M4
  - DAC/DAC_SignalsGeneration/CM4/Inc/stm32h7xx_it.h         Interrupt handlers header file for Cortex-M4


@par Hardware and Software environment  
  - This example runs on STM32H745xx devices.
    
  - This example has been tested with STM32H745I-DISCO board and can be easily tailored to any other supported 
  device and development board.

  - STM32H745I-DISCO Set-up :
      
      - Connect PA4 (DAC Channel1) (pin 13 in STMod+ P1) to an oscilloscope.
