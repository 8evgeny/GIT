...
/*##-1- Configure the HRTIM peripheral ######################################################*/
  ...
  /*##-2- Configure the HRTIM TIMB PWM channels 2 #############################################*/
  ...
  sConfig_Channel.Pulse = HRTIM_TIMB_PULSE2;
  ...
  if (HAL_HRTIM_SimplePWMStart(&HrtimHandle, HRTIM_TIMERINDEX_TIMER_B, HRTIM_OUTPUT_TB2) != HAL_OK)
  {
