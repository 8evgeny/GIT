...
This example shows how to configure the HRTIM1 peripheral to generate 1 PWM signals 
...
since APB2 prescaler is equal to 2.
  ...
  => HRTIM1CLK = HCLK
    ...
    HRTIM1 TIMB period is set to 100, so the frequency of the 
    TIMB PWM is 2MHz
    
    HRTIM1 TIMB TB2 duty cycle = (HRTIM_TIMB_PULSE2/ HRTIM1_TIMB_PER)* 100 = 65%
...
@par Hardware and Software environment  
  ...
  - STM32H745I-DISCO Set-up
   Connect the following pins to an oscilloscope to monitor the different waveforms:
        - HRTIM1_TIMB_TB2 : PA.08 (pin 6 in CN6 connector)
