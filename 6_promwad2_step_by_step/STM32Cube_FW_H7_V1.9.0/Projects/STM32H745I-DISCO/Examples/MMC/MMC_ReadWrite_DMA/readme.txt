/**
  @page MMC_ReadWrite_DMA  Description of the MMC_ReadWrite_DMA example
  
  @verbatim
  ******************** (C) COPYRIGHT 2019 STMicroelectronics *******************
  * @file    MMC/MMC_ReadWrite_DMA/readme.txt 
  * @author  MCD Application Team
  * @brief   Description of the MMC read and write buffer with internal DMA example.
  ******************************************************************************
  * @attention
  *
...
This example performs some write and read transfers to MMC card with SDMMC IP internal
...
read speed.
The transfers of write and read are performed with the MMC IP internal DMA, 
...
Storage, MMC, SDMMC, Read Write, Block, sector, DMA

@par Directory contents 

  - MMC/MMC_ReadWrite_DMA/Inc/stm32h7xx_hal_conf.h    HAL configuration file
  - MMC/MMC_ReadWrite_DMA/Inc/stm32h7xx_it.h          Interrupt handlers header file
  - MMC/MMC_ReadWrite_DMA/Inc/main.h                  Header for main.c module  
  - MMC/MMC_ReadWrite_DMA/Src/stm32h7xx_it.c          Interrupt handlers
  - MMC/MMC_ReadWrite_DMA/Src/main.c                  Main program
  - MMC/MMC_ReadWrite_DMA/Src/stm32h7xx_hal_msp.c     HAL MSP module
  - MMC/MMC_ReadWrite_DMA/Src/system_stm32h7xx.c      STM32H7xx system source file
