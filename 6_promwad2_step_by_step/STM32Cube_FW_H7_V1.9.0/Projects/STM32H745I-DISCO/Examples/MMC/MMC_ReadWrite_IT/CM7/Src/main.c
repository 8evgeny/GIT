  ...
  while(1)
  {
    switch(step)
    {
      ...
      case 1:
      {
        ...
        if(HAL_MMC_WriteBlocks_IT(&MMCHandle, aTxBuffer, ADDRESS, NB_BLOCK_BUFFER) != HAL_OK)
        {
          Error_Handler();
        }
        step++;
      ...
      case 4:
      {
        ...
        RxCplt = 0;
        if(HAL_MMC_ReadBlocks_IT(&MMCHandle, aRxBuffer, ADDRESS, NB_BLOCK_BUFFER) != HAL_OK)
        {
          Error_Handler();
        }
        step++;
