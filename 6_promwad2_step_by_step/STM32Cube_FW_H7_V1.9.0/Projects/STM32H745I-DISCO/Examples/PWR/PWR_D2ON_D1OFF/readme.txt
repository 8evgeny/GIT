...
After compiling CM4 target the user is aimed to copy the STM32H745I_CM4.bin file 
...
the code copied before by CM7 from Flash to D2SRAM memory. 
...
passed and if D1 is in RUN mode the LED2 will set ON to indicate test failed.
...
In order to make the program work, you must do the following :
 ...
 - Deactivate CM4 boot : go to STM32CubeProgrammer, in Option Bytes menu unselect
   BOOT CM4 from the "User configuration" section.
   
 - Open your preferred toolchain 
  - For CM4 target configuration (STM32H745I_DISCO_CM4)
     - Rebuild all files.
