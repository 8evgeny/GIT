...
@par Directory contents 
  ...
  - Templates/BootCM4_CM7Gated/Common/Inc/ft5336_conf.h          Configuration file for ft5336
  - Templates/BootCM4_CM7Gated/Common/Inc/mt25tl01g_conf.h       Configuration file for mt25tl01g 
  - Templates/BootCM4_CM7Gated/Common/Inc/mt48lc4m32b2_conf.h    Configuration file for mt48lc4m32b2
...
In order to make the program work, you must do the following :
 ...
 - For each target configuration (STM32H745I_DISCO_CM7 first then STM32H745I_DISCO_CM4) : 
     - Rebuild all files 
- For  STM32H745I_DISCO_CM4 target configuration:
     - Load CM4 image into target memory (CM7 image is included in a section of the CM4 output hex file)

- Run the STM32H745I_DISCO_CM4 target configuration : the CM4 will release the CM7 boot.
