...
In this example:
    ...
    - When 100 "message" are correctly exchanged, le LED1 starts toggling.
...
@par Directory contents
    ...
    - OpenAMP/OpenAMP_PingPong/Common/Inc/mbox_hsem.h           Mailbox configuration for OpenAMP header file
...
@par Hardware and Software environment
  ...
  - This example has been tested with STM32H7xx_DISCO board and can be
