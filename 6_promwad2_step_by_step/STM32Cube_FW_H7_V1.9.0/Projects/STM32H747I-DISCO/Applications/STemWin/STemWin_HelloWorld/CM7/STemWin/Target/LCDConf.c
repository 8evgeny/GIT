...
*         This signal is only cabled on Discovery and beyond.
*/
...
{   
  ...
  */
  ...
  /* PLL3_VCO Output = PLL3_VCO Input * PLL3N = 660 Mhz */
  /* PLLLCDCLK = PLL3_VCO Output/PLL3R = 660/25 = 26.4 Mhz */
  /* LTDC clock frequency = PLLLCDCLK = 26.4 Mhz */
...
//  _DMA_Fill(0,(U32 *)LCD_FRAME_BUFFER, XSIZE_PHYS, YSIZE_PHYS, 0, 0x00); 
