/**
  ******************************************************************************
  * @file    MenuLauncher/Modules/splashscreen/AVI_parser.c 
...
/* Private functions ---------------------------------------------------------*/
static AVISTATUS __AVI_Init( AVI_CONTEXT * pavi, uint8_t *buf, uint16_t size);
static uint32_t  __AVI_SearchID(uint8_t* buf,  uint16_t size, uint8_t *id);
static AVISTATUS __AVI_GetStreamInfo( AVI_CONTEXT * pavi, uint8_t* buf);
