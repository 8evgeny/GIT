/**
  ...
  *          - Update the name of the JPEG driver's header file, depending on the board you are using.
  *    
  *        Example if using the STM32H747I-DISCO board :
  *          - Copy the file "jpeg_utils_conf_template.h" to the application folder and rename it to "jpeg_utils_conf.h"
  *          - Edit the "jpeg_utils_conf.h" and change lines 45 and 46 as follow :
