/**
  ******************************************************************************
  * @file    SPDIFRX/SPDIFRX_AudioPlay/CM7/Src/stm32h7xx_it.c
...
/**
  * @brief  This function handles SPDIFRX DMA interrupt request.
  * @param  None
  * @retval None
  */
void DMA1_Stream1_IRQHandler(void)
{ 
  HAL_DMA_IRQHandler(SpdifrxHandle.hdmaDrRx);
}
