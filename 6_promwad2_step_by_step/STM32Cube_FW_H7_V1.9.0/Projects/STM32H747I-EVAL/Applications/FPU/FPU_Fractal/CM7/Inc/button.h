/**
  ******************************************************************************
  * @file    FPU/FPU_Fractal/CM7/Inc/button.h
...
#define ZOOM_IN_BUTTON_XPOS  ((LCD_X_SIZE/2) + (3 * (ZOOM_BUTTON_WIDTH/2))) - 20
#define ZOOM_IN_BUTTON_YPOS  (LCD_Y_SIZE - ZOOM_BUTTON_HEIGHT - (ZOOM_BUTTON_HEIGHT/2)) 
  
#define ZOOM_OUT_BUTTON_XPOS  ((LCD_X_SIZE/2) - (5 * (ZOOM_BUTTON_WIDTH/2))) + 20
