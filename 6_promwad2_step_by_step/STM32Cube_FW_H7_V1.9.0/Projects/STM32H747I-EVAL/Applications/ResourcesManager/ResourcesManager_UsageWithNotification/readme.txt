/**
  @page ResourcesManager_UsageWithNotification ResourcesManager Usage With Notification application
...
STM32H747I_EVAL board's LEDs and Uart messages can be used to monitor the execution status:
...
STM32H747I_EVAL board's USART1 Connector have to connected to PC UART COM:
