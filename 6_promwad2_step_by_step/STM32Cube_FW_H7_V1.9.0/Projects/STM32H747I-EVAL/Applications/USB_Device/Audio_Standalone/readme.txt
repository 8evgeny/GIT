...
(Out: Speaker/Headset) capability on the STM32H7xx devices.
...
This is a typical application on how to use the STM32H7xx USB OTG Device peripheral and SAI peripheral to
stream audio data from USB Host to the audio codec implemented on the STM32H747I-EVAL board.
...
@par Directory contents
  ...
  - USB_Device/AUDIO_Standalone/CM7/Src/main.c                  Main program
  - USB_Device/AUDIO_Standalone/CM7/Src/stm32h7xx_it.c          Interrupt handlers
  - USB_Device/AUDIO_Standalone/CM7/Src/usbd_audio_if.c         USBD Audio interface
  - USB_Device/AUDIO_Standalone/CM7/Src/usbd_conf.c             General low level driver configuration
  - USB_Device/AUDIO_Standalone/CM7/Src/usbd_desc.c             USB device AUDIO descriptor
  - USB_Device/AUDIO_Standalone/CM7/Inc/main.h                  Main program header file
  - USB_Device/AUDIO_Standalone/CM7/Inc/stm32h7xx_it.h          Interrupt handlers header file
  - USB_Device/AUDIO_Standalone/CM7/Inc/stm32h7xx_hal_conf.h    HAL configuration file
  - USB_Device/AUDIO_Standalone/CM7/Inc/usbd_conf.h             USB device driver Configuration file
  - USB_Device/AUDIO_Standalone/CM7/Inc/usbd_desc.h             USB device AUDIO descriptor header file
  - USB_Device/AUDIO_Standalone/CM7/Inc/usbd_audio_if.h         USBD Audio interface header file
