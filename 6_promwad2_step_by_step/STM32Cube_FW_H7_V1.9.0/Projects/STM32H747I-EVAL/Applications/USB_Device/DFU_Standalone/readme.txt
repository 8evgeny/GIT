...
In order to make the program work, you must do the following :
 ...
 - To run the application, proceed as follows:
   ...
   * With "DfuSe Demonstrator":
    ...
    - Open "DfuSe Demo" and download the "STM32H747I_EVAL_USBD_0x08020000.dfu" provided in Binary directory.
   ...
   * With "STM32CubeProgrammer":
    ...
    - Download the "STM32H747I_EVAL_USBD_0x08020000.bin" provided in Binary directory and set the start address.
