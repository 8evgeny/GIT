...
using the native PC Host HID/CDC drivers to which the STM32H747I_EVAL board is connected.
...
the STM32H747I_EVAL board, allow to user to emulate the Mouse directions.
...
@par Directory contents
  ...
  - USB_Device/DualCore_Standalone/CM7/Src/main.c                  Main program
  - USB_Device/DualCore_Standalone/CM7/Src/stm32h7xx_it.c          Interrupt handlers
  - USB_Device/DualCore_Standalone/CM7/Src/usbd_conf.c             General low level driver configuration
  - USB_Device/DualCore_Standalone/CM7/Src/usbd_cdc_desc.c         USB device CDC descriptor
  - USB_Device/DualCore_Standalone/CM7/Src/usbd_hid_desc.c         USB device HID descriptor
  - USB_Device/DualCore_Standalone/CM7/Src/stm32h7xx_hal_msp.c     HAL MSP module
  - USB_Device/DualCore_Standalone/CM7/Src/usbd_cdc_interface.c    USBD CDC interface 
  - USB_Device/DualCore_Standalone/CM7/Inc/main.h                  Main program header file
  - USB_Device/DualCore_Standalone/CM7/Inc/stm32h7xx_it.h          Interrupt handlers header file
  - USB_Device/DualCore_Standalone/CM7/Inc/stm32h7xx_hal_conf.h    HAL configuration file
  - USB_Device/DualCore_Standalone/CM7/Inc/usbd_conf.h             USB device driver Configuration file
  - USB_Device/DualCore_Standalone/CM7/Inc/usbd_desc.h             USB device descriptor header file  
  - USB_Device/DualCore_Standalone/CM7/Inc/usbd_cdc_desc.h         USB device CDC descriptor header file
  - USB_Device/DualCore_Standalone/CM7/Inc/usbd_hid_desc.h         USB device HID descriptor header file
  - USB_Device/DualCore_Standalone/CM7/Inc/usbd_cdc_interface.h    USBD CDC interface header file
...
@par Hardware and Software environment
  ...
  - STM32H747I-EVAL  Set-up
    ...
    - For loopback mode test: remove RS232 cable on CN2 and connect directly USART TX and RX pins:
      PB14 and PB15 in connector CN6(with a cable or a jumper)
...
- Open your preferred toolchain 
 ...
 - For CM7 target configuration  (STM32H747I-EVAL_USB) :
