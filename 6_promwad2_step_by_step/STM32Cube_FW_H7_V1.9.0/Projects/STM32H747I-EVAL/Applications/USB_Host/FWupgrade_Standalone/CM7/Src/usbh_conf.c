/**
  ******************************************************************************
  * @file    USB_Host/FWupgrade_Standalone/CM7/Src/usbh_conf.c
...
void HAL_HCD_MspInit(HCD_HandleTypeDef * hhcd)
{
  ...
  /* Initialize the IO & Configure POWER_SWITCH IO pin */
    io_init_structure.Pin  = MFXSTM32L152_GPIO_PIN_7;
...
USBH_StatusTypeDef USBH_LL_DriverVBUS(USBH_HandleTypeDef * phost, uint8_t state)
{
  ...
  if (state == 0)
  {
    ...
    BSP_IO_WritePin(0, MFXSTM32L152_GPIO_PIN_7, IO_PIN_RESET);
  }
  else
  {
    /* Drive High Charge pump */
    BSP_IO_WritePin(0, MFXSTM32L152_GPIO_PIN_7, IO_PIN_SET);
  }
#endif
  HAL_Delay(200);
  return USBH_OK;
