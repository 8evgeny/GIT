...
#define STFW_FIRMWARE_VERSION           0xF1010000
...
#define STFW_RESOURCES_VERSION          0xE1010000
...
#define CUC_FIRMWARE_VERSION            0xC4010000
...
#define CUC_RESOURCES_VERSION           0xD4010000
...
static const GUI_WIDGET_CREATE_INFO _aInfoDialogCreate[] = {
  ...
  { TEXT_CreateIndirect   , "STM32H7x7I-EVAL"     , ID_TEXT_BOARD_VAL     , 220 , 203 , 250 ,  30 , (GUI_TA_LEFT | GUI_TA_TOP)     , 0x0, 0 },
...
static void _cbMainDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_NOTIFY_PARENT:
    ...
    {
      switch(Id) {
        /* Notifications sent by 'STemWin' */
        case ID_BUTTON_DEMO_1:
        /* Notifications sent by 'TouchGFX' */
        case ID_BUTTON_DEMO_2:
        /* Notifications sent by 'TARA' */
        case ID_BUTTON_DEMO_3:
          Demo_Id = GetDemoIndex(Id);
          break;
      }
