...
typedef void GUI_AVI_FUNC(GUI_AVI_HANDLE havi, int Notification, U32 SkipNFrames);
typedef U32 GUI_SEEK_FUNC(void * p, unsigned NumBytesToSeek, U32 Pos);
...
#define GUI_AVI_NOTIFICATION_SKIP     6 /* Skip current image                 */
