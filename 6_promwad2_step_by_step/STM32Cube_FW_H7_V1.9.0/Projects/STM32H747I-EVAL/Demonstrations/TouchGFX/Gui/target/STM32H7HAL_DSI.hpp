...
#ifndef STM32H7HAL_DSI_HPP
#define STM32H7HAL_DSI_HPP

#include <touchgfx/hal/HAL.hpp>
#include <platform/driver/touch/TouchController.hpp>

/**
 * @class STM32H7HAL_DSI STM32H7HAL_DSI.hpp
 *
 ...
 * @sa HAL
 */
class STM32H7HAL_DSI : public touchgfx::HAL
{
public:
    /**
     ...
     */
    STM32H7HAL_DSI(touchgfx::DMA_Interface& dma, touchgfx::LCD& display, touchgfx::TouchController& tc, uint16_t width, uint16_t height) : touchgfx::HAL(dma, display, tc, width, height)
    {
    }
