...
@par Hardware and Software environment
  ...
  - Connect the STM32H747I-EVAL board to PC with USB cable through CN2
	  
  - Use "STFirmware-STM32H747I-EVAL_OoB_VX.Y.Z.hex" file provided under “Binary” with 
    STM32CubeProgrammer to program the board.
	
The binary files are available from the STM32H747I-EVAL page in the Binary Delivery section.
