...
static void LCD_Show_Feature(uint8_t feature)
{
  ...
  case 4:
    BSP_SDRAM_DeInit(0);
    BSP_LCD_DeInit(0);
    BSP_LCD_InitEx(0, LCD_ORIENTATION_LANDSCAPE, LTDC_PIXEL_FORMAT_RGB565, 800, 480);
    ...
    UTIL_LCD_SetFont(&Font12);
    UTIL_LCD_DisplayStringAt(0, 30, (uint8_t *)"This example shows the different", CENTER_MODE);
    UTIL_LCD_DisplayStringAt(0, 45, (uint8_t *)"LCD Features", CENTER_MODE);
    HAL_Delay(2000);
    BSP_SDRAM_DeInit(0);
    BSP_LCD_DeInit(0);
    BSP_LCD_InitEx(0, LCD_ORIENTATION_PORTRAIT, LTDC_PIXEL_FORMAT_RGB565, 480, 800);
    UTIL_LCD_SetFuncDriver(&LCD_Driver);
    UTIL_LCD_SetFont(&UTIL_LCD_DEFAULT_FONT);
    /* Clear the LCD */
    UTIL_LCD_SetBackColor(UTIL_LCD_COLOR_BLUE);
    ...
    BSP_SDRAM_DeInit(0);
    BSP_LCD_DeInit(0);
    BSP_LCD_InitEx(0, LCD_ORIENTATION_PORTRAIT, LTDC_PIXEL_FORMAT_RGB888, 480, 800);
    UTIL_LCD_SetFuncDriver(&LCD_Driver);
    UTIL_LCD_SetFont(&UTIL_LCD_DEFAULT_FONT);
    /* Clear the LCD */
    UTIL_LCD_SetBackColor(UTIL_LCD_COLOR_BLUE);
