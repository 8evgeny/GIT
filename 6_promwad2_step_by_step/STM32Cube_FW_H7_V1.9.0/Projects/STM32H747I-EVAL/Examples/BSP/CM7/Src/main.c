/**
  ...
  * @brief   This example code shows how to use the STM32H747I_EVAL BSP Drivers.
...
BSP_DemoTypedef  BSP_examples[]=
{
  ...
  {LCD_demo, "LCD demo", 1},
  {Touchscreen_demo1, "TOUCHSCREEN DEMO1", 2},
  {Touchscreen_demo2, "TOUCHSCREEN DEMO2", 3},
  {Touchscreen_demo3, "TOUCHSCREEN DEMO3", 4},
  {POTENTIOMETER_demo, "POTENTIOMETER", 5},
  {AudioPlay_demo, "SET VOLUME/ SET SAMPLE RATE", 6},
  {AudioRec_demo, "SAI DIGITAL REC", 7},
  {REC_INSTANCE2_PDM_demo, "PDM Recording", 8},
  {REC_INSTANCE1_SingleBuff_demo, "DFSDM SINGLE-BUFF RECORD", 9},
  {QSPI_demo, "QSPI TEST", 10},
  {EEPROM_demo, "EEPROM TEST", 11},
  {SD_POLLING_demo, "SD POLLING TEST", 12},
  {SD_DMA_demo, "SD DMA TEST", 13},
  {SD_IT_demo, "SD IT TEST", 14},
  {NOR_demo, "NOR TEST", 15},
  {SRAM_demo, "SRAM TEST", 16},
  {SRAM_DMA_demo, "SRAM DMA TEST", 17},
  {SDRAM_demo, "SDRAM TEST", 18},
  {SDRAM_DMA_demo, "SDRAM DMA TEST", 19},
};
/* Private define ------------------------------------------------------------*/
#define KEYS_NUMBER              6 /* Button + joystick */
#define DEBOUNCE                 500 /* 100ms */
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
uint8_t DemoIndex = 0;
...
static void Display_DemoDescription(void)
{
  ...
  UTIL_LCD_DisplayStringAt(0, y_size / 2 + 30, (uint8_t *)"Press Tamper button to start :", CENTER_MODE);
