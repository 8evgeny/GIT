...
buffer (SRC_Buffer_LED1_Toggle) to the GPIOK ODR register (in order to toggle LED1).
...
As consequence the DMA will serve the request and write a new value to the GPIOK ODR register to toggle the LED1
