/**
  ******************************************************************************
  * @file    FLASH\FLASH_CoreConfiguration\CM7\Src\main.c
  * @author  MCD Application Team
  * @brief   Main program body for CPU1 (Cortex-M7)
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
 uint32_t i;
 uint32_t Address;
 uint32_t *buffer_adrress = (uint32_t *)acCM4_Code;
 ...
 /* STM32H7xx HAL library initialization:
  ...
  /* Erase the user Flash area Bank2 */
