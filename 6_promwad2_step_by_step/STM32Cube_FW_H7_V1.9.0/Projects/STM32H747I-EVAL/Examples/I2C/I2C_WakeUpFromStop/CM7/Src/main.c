/**
  ******************************************************************************
  * @file    I2C/I2C_WakeUpFromStop/CM7/Src/main.c
...
uint8_t aRxBuffer_master[RXBUFFERSIZE];
...
int main(void)
{
  ...
  */
  ...
  do
  {
    if(HAL_I2C_Master_Receive_IT(&I2cHandle, (uint16_t)I2C_ADDRESS, (uint8_t *)aRxBuffer_master, RXBUFFERSIZE) != HAL_OK)
    {
      /* Error_Handler() function is called when error occurs. */
      Error_Handler();
    }
  ...
  if(Buffercmp((uint8_t*)aTxBuffer,(uint8_t*)aRxBuffer_master,RXBUFFERSIZE))
  {
    /* Processing Error */
    Error_Handler();
  }
