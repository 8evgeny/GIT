...
In order to make the program work, you must do the following :
 ...
 - For each target configuration (STM32H747I_EVAL_CM7 first then STM32H747I_EVAL_CM4) :
     - Rebuild all files
...
- Run the STM32H747I_EVAL_CM4 target configuration : the CM4 will release the CM7 boot.
