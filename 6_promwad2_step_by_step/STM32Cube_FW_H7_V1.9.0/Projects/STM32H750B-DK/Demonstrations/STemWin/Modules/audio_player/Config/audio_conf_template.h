/**
  ******************************************************************************
  * @file    audio_conf_template.h
  * @author  MCD Application Team
  * @brief   Audio processing configuration template file. 
...
/* Board Specific Audio Package Header file */
#if defined(USE_STM32469I_EVAL)
#include "stm32469i_eval_audio.h"
#elif defined(USE_STM32469I_DISCO) || defined(USE_STM32469I_DISCOVERY)
#include "stm32469i_discovery_audio.h"
#elif defined(USE_STM32769I_EVAL)
#include "stm32f769i_eval_audio.h"
#elif defined(USE_STM32769I_DISCO) || defined(USE_STM32769I_DISCOVERY)
#include "stm32f769i_discovery_audio.h"
#elif defined(USE_STM32L4R9I_EVAL)
#include "stm32l4r9i_eval_audio.h"
#elif defined(USE_STM32L4R9I_DISCO) || defined(USE_STM32L4R9I_DISCOVERY)
#include "stm32l4r9i_discovery_audio.h"
#elif defined(USE_STM32L496G_DISCO) || defined(USE_STM32L496G_DISCOVERY)
#include "stm32l496g_discovery_audio.h"
#elif defined(USE_STM32H747I_EVAL)
#include "stm32h747i_eval_audio.h"
#elif defined(USE_STM32H747I_DISCO) || defined(USE_STM32H747I_DISCOVERY)
...
/* #define __MP3_DECODER__ */   /* uncomment this to enable MP3 audio decode support. This Support not yet fully tested and validated! */
/* #define __AVI_DECODER__ */   /* uncomment this to enable AVI audio decode support. This Support not yet fully tested and validated! */
