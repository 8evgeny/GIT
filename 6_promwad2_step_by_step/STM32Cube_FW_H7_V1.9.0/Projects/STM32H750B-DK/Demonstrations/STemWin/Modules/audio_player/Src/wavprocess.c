/**
  ******************************************************************************
  * @file    audio_player/Src/wavprocess.c
...
/** @defgroup WAV_PROCESS
* @brief Audio Wave Processing routines
* @{
*/
...
/** @defgroup WAV_PROCESS_Private_Variables
* @{
*/
...
/** @defgroup WAV_PROCESS_Private_Functions
* @{
*/
/* Function Prototypes */
#ifdef __WAV_DECODER__
                            ...
                            void *pUserData)
{
  ...
  memset(&DecWavFmtStruct, 0, sizeof(WAVE_FormatTypeDef));
  ...
  pWAVUserData       = pUserData;

  /* Go the start of audio payload */
  pWAVSetPosCallback(pWAVUserData, DecWavFmtStruct.AudioStartAddr);
...
uint32_t WavProcess_DecSetProgressTime(uint32_t NewTime)
{
  ...
  pWAVSetPosCallback(pWAVUserData, NewPos);
