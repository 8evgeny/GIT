...
RecipeSelectedScreenViewBase::RecipeSelectedScreenViewBase() :
    buttonCallback(this, &RecipeSelectedScreenViewBase::buttonCallbackHandler),
    flexButtonCallback(this, &RecipeSelectedScreenViewBase::flexButtonCallbackHandler)
{
    ...
    buttonPlay.setXY(195, 91);
    buttonPlay.setBitmaps(touchgfx::Bitmap(BITMAP_PLAY_VIDEO_ICON_ID), touchgfx::Bitmap(BITMAP_PLAY_VIDEO_ICON_ID));
    buttonPlay.setAction(buttonCallback);
    scrollableContainerRecipe.add(buttonPlay);
...
void RecipeSelectedScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &buttonPlay)
    {
        //InteractionPlayButton
