/**
  ******************************************************************************
  * @file    PWR/PWR_STOP_STANDBY/Src/main.c
...
int main(void)
{
  ...
  */
  ...
  /* This code will be reached if SYSTEM_STOP is defined */
  while (1)
  {
  }
}
