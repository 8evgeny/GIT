...
int main(void)
{
	   /*  -------------------------------------------------------
	     ...
	     This application is running on a STM32H7B3 Discovery board
  ...
  /* Initialize the blue and red leds of the discovery board */
  BSP_LED_Init(LED2);
  BSP_LED_Init(LED3);
...
static  void Display_background (void)
{
  ...
  UTIL_LCD_DisplayStringAt(0, 5, (uint8_t *)"STM32H7B3I-DK", CENTER_MODE);
  ...
  StepCounter = 0;
   ...
   /* Code executed when the security bit, RDP level and the secure area are not set */
    if((ButtonState != 0) && (StepCounter == 0) && (security_bit == 0) && (security_area_set == 0) && (rdp_level == 0))
    {
      ...
      HAL_Delay(2000);
      BSP_LED_Toggle(LED2); /* Blue led*/
      UTIL_LCD_DisplayStringAt(0, y_size / 2 , (uint8_t *)"The blue LED is ON", CENTER_MODE);
      HAL_Delay(2000);
   ...
   /* Code executed when the security bit is set and the secure area and RDP level are not set  */
    if((ButtonState != 0) && (StepCounter == 0) && (security_bit == 1)&& (security_area_set == 0) && (rdp_level == 0))
    {
      ...
      HAL_Delay(2000);
      BSP_LED_Toggle(LED2); /* Blue led*/
      UTIL_LCD_DisplayStringAt(0, y_size / 2 + 15 , (uint8_t *)"The blue LED is ON", CENTER_MODE);
      HAL_Delay(2000);
   ...
   /* Code executed when both the security bit, the secure area are set and RDP level is not set*/
    if((ButtonState != 0) && (StepCounter == 0) && (security_bit == 1) && (security_area_set != 0) && (rdp_level == 0))
    {
      ...
      Display_background ();
      BSP_LED_Toggle(LED2); /* Blue led*/
      UTIL_LCD_DisplayStringAt(0, y_size / 2 - 30 , (uint8_t *)"The blue LED will be ON", CENTER_MODE);
      HAL_Delay(2000);
