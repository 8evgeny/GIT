...
The High Speed (HS) USB module uses
internally a 60-MHz clock.
...
In this application, two operating modes are available:
 ...
 2. Run-time application mode:
    This is the normal run-time activities. This is the normal run-time activities. A binary which toggles LEDs on the STM32H7B3I-DISCO board is provided in Binary directory.

@note After each device reset (unplug the STM32H7B3I-DK board from PC), Plug the STM32H7B3I-DK board with Key User Button button
...
@note A binary which toggles LEDs on the STM32H7B3I-DK board is provided in Binary directory.
...
@par Hardware and Software environment
  ...
  - This application has been tested with STMicroelectronics STM32H7B3I-DK
    board and can be easily tailored to any other supported device
    and development board.

  - STM32H7B3I-DK board Set-up
    ...
    - Connect the STM32H7B3I-DK board to the PC through micro A-Male to standard A Male cable connected to the connector:
     - CN15 : to use USB High Speed (HS).Make sure that SB40 is fitted.
...
In order to make the program work, you must do the following:
  ...
  * With "DfuSe Demonstrator":
   ...
   - Open "DfuSe Demo", choose the "STM32H7B3I-DK_LED_Toggle@0x0800C000.dfu" provided in Binary
  ...
  * With "STM32CubeProgrammer":
    ...
    - Download the "STM32H7B3I-DK_LED_Toggle@0x0800C000.bin" provided in Binary directory and set the start address.
