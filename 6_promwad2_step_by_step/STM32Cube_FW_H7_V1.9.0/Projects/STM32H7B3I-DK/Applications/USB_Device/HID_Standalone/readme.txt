...
enumerated as a HID device using the native PC Host HID driver to which the STM32H7B3I-DK
...
@par Hardware and Software environment
  ...
  - This application has been tested with STMicroelectronics STM32H7B3I-DK board
  ...
  - STM32H7B3I-DK board Set-up
    ...
    - Press the User Button  to move the cursor.
