...
@par Directory contents
   ...
   - USB_Host/MSC_Standalone/Core/Inc/stm32h7b3i_discovery_conf.h       Hardware configuration File 
...
@par Hardware and Software environment
  ...
  - STM32H7B3I-DK Set-up
    - Plug the USB key into the STM32H7B3I-DK board through 'USB micro A-Male
