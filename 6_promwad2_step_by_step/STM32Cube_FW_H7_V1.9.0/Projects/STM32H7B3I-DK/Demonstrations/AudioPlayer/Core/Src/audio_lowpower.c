...
static void AUDIOLP_WakeupEventConfig(void)
{
  ...
  /* Config User button wakeup EXTI event(13) for CPU wakeup (in D1 domain) */
  HAL_EXTI_D1_EventInputConfig(EXTI_LINE13, EXTI_MODE_IT, ENABLE);
  
  /* Config micro SD wakeup EXTI event(8) for CPU wakeup (in D1 domain) */
  HAL_EXTI_D1_EventInputConfig(EXTI_LINE8, EXTI_MODE_IT, ENABLE); 
