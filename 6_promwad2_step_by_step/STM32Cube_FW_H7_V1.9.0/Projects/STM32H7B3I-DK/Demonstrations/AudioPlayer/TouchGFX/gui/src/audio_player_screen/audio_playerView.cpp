...
void audio_playerView::albumButtonPressed()
{
    ...
    trackSelectorBox.startMoveAnimation(230, trackSelectorBox.getY(), 18, touchgfx::EasingEquations::cubicEaseIn, touchgfx::EasingEquations::cubicEaseIn);
...
void audio_playerView::noMediaFilesDetected(bool filesDetected)
{
    ...
    bottomBarContainer.setVisible(filesDetected);
    playPauseAnimation.setVisible(filesDetected);

    background.invalidate();
    bottomBarContainer.invalidate();
