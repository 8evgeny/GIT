...
struct Typography
{
    ...
    static const touchgfx::FontId INFO = 1;
};

struct TypographyFontIndex
{
    static const touchgfx::FontId HEADLINE = 0; // Saira_Medium_28_4bpp
    static const touchgfx::FontId INFO = 1;     // Saira_Medium_14_4bpp
