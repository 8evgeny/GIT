...
extern touchgfx::GeneratedFont& getFont_Saira_Medium_14_4bpp();

const touchgfx::Font* _fonts[] =
{
    &(getFont_Saira_Medium_28_4bpp()),
    &(getFont_Saira_Medium_14_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        _fonts[0] = &(getFont_Saira_Medium_28_4bpp());
        break;
    case 1:
        _fonts[1] = &(getFont_Saira_Medium_14_4bpp());
        break;
    }
}
}  // namespace TypedTextDatabase
