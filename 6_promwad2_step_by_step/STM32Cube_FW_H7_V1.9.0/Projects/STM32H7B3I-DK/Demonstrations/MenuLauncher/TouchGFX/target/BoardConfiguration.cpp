...
#define LCD_ON_OFF_PULL                       GPIO_PULLUP
#define LCD_ON_OFF_GPIO_PORT                  GPIOA
#define LCD_ON_OFF_GPIO_CLK_ENABLE()          __HAL_RCC_GPIOA_CLK_ENABLE()
#define LCD_ON_OFF_GPIO_CLK_DISABLE()         __HAL_RCC_GPIOA_CLK_DISABLE()

/* LCD Display enable pin */
#define LCD_DE_PIN                            GPIO_PIN_7
#define LCD_DE_PULL                           GPIO_NOPULL
#define LCD_DE_GPIO_PORT                      GPIOK
#define LCD_DE_GPIO_CLK_ENABLE()              __HAL_RCC_GPIOK_CLK_ENABLE()
#define LCD_DE_GPIO_CLK_DISABLE()             __HAL_RCC_GPIOK_CLK_DISABLE()
...
#define LCD_INT_PULL                          GPIO_PULLUP
#define LCD_INT_GPIO_PORT                     GPIOH
#define LCD_INT_GPIO_CLK_ENABLE()             __HAL_RCC_GPIOH_CLK_ENABLE()
#define LCD_INT_GPIO_CLK_DISABLE()            __HAL_RCC_GPIOH_CLK_DISABLE()
...
static void LCD_MspInit(void)
{
  ...
  LCD_ON_OFF_GPIO_CLK_ENABLE();
  LCD_BL_CTRL_GPIO_CLK_ENABLE();
  LCD_DE_GPIO_CLK_ENABLE();
  LCD_INT_GPIO_CLK_ENABLE();

  /* LCD_DISP_EN GPIO configuration */
  gpio_init_structure.Pin       = LCD_DE_PIN;     /* LCD_DISP pin has to be manually controlled */
  gpio_init_structure.Mode      = GPIO_MODE_OUTPUT_PP;
  gpio_init_structure.Pull      = LCD_DE_PULL;
  HAL_GPIO_Init(LCD_DE_GPIO_PORT, &gpio_init_structure);

  /* LCD_DISP_CTRL GPIO configuration */
  gpio_init_structure.Pin       = LCD_ON_OFF_PIN;     /* LCD_DISP pin has to be manually controlled */
  gpio_init_structure.Mode      = GPIO_MODE_OUTPUT_PP;
  gpio_init_structure.Pull      = LCD_ON_OFF_PULL;
  HAL_GPIO_Init(LCD_ON_OFF_GPIO_PORT, &gpio_init_structure);
  ...
  /* TS Interrupt configuration */
  gpio_init_structure.Pin = LCD_INT_PIN;
  gpio_init_structure.Mode = GPIO_MODE_INPUT;
  gpio_init_structure.Pull = LCD_INT_PULL;
  HAL_GPIO_Init(LCD_INT_GPIO_PORT, &gpio_init_structure);
}
