...
static const GUI_WIDGET_CREATE_INFO _aDialog[] = 
{
  ...
  { TEXT_CreateIndirect, "STM32H7B3I", ID_TEXT_BOARD_1,       20, 200, 140,  20, (GUI_TA_HCENTER | GUI_TA_VCENTER), 0x0, 0 },
  ...
  { TEXT_CreateIndirect, "280MHz", ID_TEXT_CPU0_SPEED,        220, 200, 140,  20, (GUI_TA_HCENTER | GUI_TA_VCENTER), 0x0, 0 },
  { TEXT_CreateIndirect, "V1.0.0", ID_TEXT_VERSION_1,         325, 200, 140,  20, (GUI_TA_HCENTER | GUI_TA_VCENTER), 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg)
{
  ...
  switch (pMsg->MsgId) 
  {
    case WM_INIT_DIALOG:
      ...
      /* Initialization of 'Board : STM32H7B3I' */
