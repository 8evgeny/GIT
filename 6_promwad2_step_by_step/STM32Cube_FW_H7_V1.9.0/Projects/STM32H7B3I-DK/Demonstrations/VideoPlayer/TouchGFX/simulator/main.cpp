...
#error Unknown USE_BPP
	...
	touchgfx::HAL& hal = touchgfx::touchgfx_generic_init<touchgfx::HALSDL2>(dma, lcd, tc, SIM_WIDTH, SIM_HEIGHT, bmpcache, sizeof(bmpcache), 128);
