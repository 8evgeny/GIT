...
the DAC channel one:
    - Triangle waveform (Channel 1), amplitude: ~1V, frequency: order of Hz.
    - Escalator waveform (Channel 1) using DMA transfer, amplitude: ~3V, frequency: order of KHz.

	
STM32H7B3I-DK board's LEDs can be used to monitor the process status:
...
@par Directory contents
  ...
  - DAC/DAC_SignalsGeneration/Inc/stm32h7b3i_discovery_conf.h  STM32H7B3I-DK board configuration file
