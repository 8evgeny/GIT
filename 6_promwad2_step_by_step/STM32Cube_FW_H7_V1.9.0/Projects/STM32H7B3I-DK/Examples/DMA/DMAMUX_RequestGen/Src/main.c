...
__attribute__((at(0x38000000))) uint32_t SRC_Buffer_LED2_Toggle[2]  =
                                      {  0,          /*Value for LED2 ON  */
                                         LED2_PIN    /*Value for LED2 OFF */
                                      };
#elif defined ( __GNUC__ )
uint32_t __attribute__((section (".RAM_D3"))) SRC_Buffer_LED2_Toggle[2]  =
                                      {  0,          /*Value for LED2 ON  */
                                         LED2_PIN    /*Value for LED2 OFF */
                                      };
#endif
...
int main(void)
{
  ...
  /* -1- Initialize LEDs mounted on STM32H7B3I-DISCO board */
  BSP_LED_Init(LED2);
...
static void Error_Handler(void)
{
  /* Initialize LED3 mounted on STM32H7B3I-DISCO board */
  BSP_LED_Init(LED3);
