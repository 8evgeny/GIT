...
STM32H7B3I-DK board's LEDs can be used to monitor the transfer status:
 ...
 - LED3 toggles each 100ms when there is a DMA2D transfer error.
...
@par Directory contents
    ...
    - DMA2D/DMA2D_BlendingWithAlphaInversion/Inc/stm32h7b3i_discovery_conf.h    HAL configuration file  
