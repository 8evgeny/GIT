...
The STM32H7B3I-DK board LEDs can be used to monitor the transfer status:
...
@par Directory contents
  ...
  - FLASH/FLASH_EraseProgram/Inc/stm32h7b3i_discovery_conf.h      STM32H7B3I-DK board configuration file
