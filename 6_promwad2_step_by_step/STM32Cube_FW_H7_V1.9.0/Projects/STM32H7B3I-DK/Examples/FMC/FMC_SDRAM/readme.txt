...
data bus width as 16 bits, uncomment the define for the configuration 
"FMC_SDRAM_MEM_BUS_WIDTH_16".

If the data is read correctly from SDRAM, the LED2 is ON, otherwise the LED3 is ON.
If an error occurs, LED3 is Toggled.
...
@par Directory contents 
 ...
 - FMC/FMC_SDRAM/Inc/stm32h7b3i_discovery_conf.h STM32H7B3I_DISCO board configuration file.
