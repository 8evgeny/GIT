...
In this example:
    - EXTI15_10 is connected to PC.13 pin
      - when falling edge is detected on EXTI15_10 by pressing User Button, LED2 toggles once
...
@par Directory contents
  ...
  - GPIO/GPIO_EXTI/Inc/stm32h7b3i_discovery_conf.h  STM32H7B3I-DK board configuration file
