...
How to read an RGB image stored in the internal FLASH, encode it 
using the JPEG HW encoder in DMA mode and save it into SDCard.
...
The example performs the following actions :
  ...
  - The LED2 is On if the test ends properly.
  - The LED3 is On in case of LTDC Init or µSD errors.
...
@par Directory contents
  ...
  - JPEG/JPEG_EncodingFromFLASH_DMA/Inc/stm32h7b3i_discovery_conf.h     STM32H7B3I-DK board configuration file
