...
static void LCD_Config(void)
{
  ...
  LtdcHandle.Init.AccumulatedHBP     = (RK043FN48H_HSYNC + (RK043FN48H_HBP - 11U) - 1U);
  LtdcHandle.Init.AccumulatedActiveW = (RK043FN48H_WIDTH + RK043FN48H_HSYNC + RK043FN48H_HBP - 1);
  LtdcHandle.Init.TotalWidth         = RK043FN48H_HSYNC + RK043FN48H_WIDTH + (RK043FN48H_HBP - 11U) + RK043FN48H_HFP - 1U;
  ...
  /* In this case all the active display area is used to display a picture then :
     ...
     Vertical stop   = Vertical start + window height -1  = 12 + 270 -1      */
