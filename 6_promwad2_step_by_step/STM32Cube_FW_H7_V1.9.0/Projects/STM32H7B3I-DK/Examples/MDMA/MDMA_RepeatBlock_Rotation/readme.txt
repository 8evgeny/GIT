...
@par Example Description
 ...
 - config 4 :
   ...
   STM32H7B3I-DISCO's  LED can be used to monitor the transfer status:
 - LED3 is ON when there is an error in Init process or during the MDMA transfer.
 - LED2 is ON when a process iteration is complete
...
@par Directory contents
    ...
    - MDMA/MDMA_Repeat_BLock/Inc/ft5336_conf.h           FT5336 capacitive touch panel configuration file
    - MDMA/MDMA_Repeat_BLock/Inc/is42s16800j_conf.h      IS42S16800J SDRAM memory configuration file
    - MDMA/MDMA_Repeat_BLock/Inc/stm32h7b3i_discovery_conf.h  STM32H7B3I-DK board configuration file
