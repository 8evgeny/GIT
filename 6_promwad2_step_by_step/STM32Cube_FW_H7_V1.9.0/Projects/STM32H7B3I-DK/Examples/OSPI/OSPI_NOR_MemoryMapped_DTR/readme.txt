...
LED BLUE toggles each time a new comparison is good
LED RED is on as soon as a comparison error occurs
LED RED toggle as soon as an error is returned by HAL API
...
@par Directory contents 
  ...
  - OSPI/OSPI_NOR_MemoryMapped/Inc/stm32h7b3i_discovery_conf.h STM32H7B3I_EVAL board configuration file.
