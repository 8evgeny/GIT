/**
  ******************************************************************************
  * @file    OSPI/OSPI_NOR_ReadWrite_DMA/Src/stm32h7xx_hal_msp.c
...
void HAL_OSPI_MspInit(OSPI_HandleTypeDef *hospi)
{
  ...
  __HAL_RCC_MDMA_RELEASE_RESET();
   ...
   /*##-4- Configure the MDMA channel ###########################################*/
  /* Enable MDMA clock */
  /* Input MDMA */
  /* Set the parameters to be configured */ 
  hmdma.Init.Request = MDMA_REQUEST_OCTOSPI1_FIFO_TH;
  ...
  __HAL_LINKDMA(hospi, hmdma, hmdma);
