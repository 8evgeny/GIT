/**
  ******************************************************************************
  * @file    OTFDEC_EncryptionDecryption/Inc/main.h
...
#define OSPI_D0_AF                                              GPIO_AF9_OCTOSPIM_P1
...
#define OSPI_D6_AF                                              GPIO_AF9_OCTOSPIM_P1
#define OSPI_D7_PIN                                             GPIO_PIN_7
#define OSPI_D7_GPIO_PORT                                       GPIOD
#define OSPI_D7_AF                                              GPIO_AF10_OCTOSPIM_P1
...
#define OTFDEC1_REGION1_START_ADD                               0x90002000UL
#define OTFDEC1_REGION1_END_ADD                                 0x90005FFFUL
#define OTFDEC_REGION1_START_ADD                                OTFDEC1_REGION1_START_ADD
#define OTFDEC_REGION1_END_ADD                                  OTFDEC1_REGION1_END_ADD
#define OTFDEC_MODE                                             (OTFDEC_REG_MODE_INSTRUCTION_ACCESSES_ONLY_WITH_CIPHER >> 0x4UL)
//#define OTFDEC_MODE                                           (OTFDEC_REG_MODE_INSTRUCTION_OR_DATA_ACCESSES >> 0x4UL)
