...
2. When applying a high level on the time stamp pin (PC.13) by pressing the User Button,
   a time stamp event is detected and the calendar is saved in the time stamp structures.
   Each time the user presses on the User Button, the current time and time stamp are updated and displayed
...
@par Directory contents 
  ...
  - RTC/RTC_TimeStamp/Inc/stm32h7b3i_discovery_conf.h STM32H7xx board configuration file   
