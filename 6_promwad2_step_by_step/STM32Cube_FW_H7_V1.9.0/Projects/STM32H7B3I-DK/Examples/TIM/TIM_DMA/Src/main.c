/**
  ...
  * @brief   This sample code shows how to use DMA with TIM8 Update request to
  *          transfer Data from memory to TIM8 Capture Compare Register 3 (CCR3).
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
 /* This sample code shows how to use DMA with TIM8 Update request to transfer
  Data from memory to TIM8 Capture Compare Register 3 (CCR3), through the
  ...
  /* ---------------------------------------------------------------------------
  TIM8 input clock (TIM8CLK) is set to APB1 clock (PCLK1)x2, since APB1
  prescaler is 2.
    TIM1CLK = PCLK1*2
    PCLK1 = HCLK
  ...
  The objective is to configure TIM8 channel 3 to generate a PWM
