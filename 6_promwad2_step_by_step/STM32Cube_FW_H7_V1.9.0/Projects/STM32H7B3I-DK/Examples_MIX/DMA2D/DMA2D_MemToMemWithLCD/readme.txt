...
STM32H7B3I-DK board from STMicroelectronics.
...
STM32H7B3I-DK board's LEDs can be used to monitor the transfer status:
 ...
 - LED3 is ON when there is a DMA2D transfer error.
...
@par Directory contents 
  ...
  - DMA2D/DMA2D_MemToMemWithLCD/Inc/stm32h7b3i_discovery_conf.h    STM32H7B3I-DK board configuration file
  - DMA2D/DMA2D_MemToMemWithLCD/Inc/ft5336_conf.h                  Touch Screen configuration file
  - DMA2D/DMA2D_MemToMemWithLCD/Inc/is42s16800j_conf.h             SDRAM configuration file
