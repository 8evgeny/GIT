...
2. Replace source files of the LL template by the ones of the LL example, except
  ...
  This projects is configured for STM32H7B3xxQ devices using STM32CubeH7 HAL and
  running on the STM32H7B3I-DISCO board from STMicroelectronics.

  At the beginning of the main program the SystemClock_Config()function is called
  to configure the system clock for STM32H7B3xxQ Devices :
        - The CPU at 280MHz
...
@par Hardware and Software environment
  ...
  - This template runs on STM32H7B3xxQ devices.

  - This template has been tested with STMicroelectronics STM32H7B3I-DISCO
