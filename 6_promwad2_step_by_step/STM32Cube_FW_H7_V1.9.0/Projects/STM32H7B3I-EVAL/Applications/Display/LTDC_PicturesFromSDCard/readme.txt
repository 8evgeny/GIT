...
@par Directory contents
  ...
  - Display/LTDC_PicturesFromSDCard/Inc/stm32h7b3i_eval_conf.h       STM32H7B3I-EVAL board configuration file
...
@par Hardware and Software environment
  ...
  - STM32H7B3I-EVAL setup
    - Connect a uSD Card to the µSD1 connector (CN28).
    - Make sure JP15 is fitted and JP12 is in SDIO1 position
