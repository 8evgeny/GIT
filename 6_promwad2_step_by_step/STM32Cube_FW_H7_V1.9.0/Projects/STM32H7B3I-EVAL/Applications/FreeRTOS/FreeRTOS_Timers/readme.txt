...
This application creates a thread that toggle LED3 every 400 ms, and a periodic 
...
@par Directory contents
    ...
    - FreeRTOS/FreeRTOS_Timers/Inc/stm32h7b3i_eval_conf.h    BSP configuration file
