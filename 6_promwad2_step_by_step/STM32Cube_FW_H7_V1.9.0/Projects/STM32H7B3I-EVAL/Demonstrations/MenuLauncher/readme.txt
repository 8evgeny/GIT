/**
  ...
  * @brief   Description of STM32H7B3I-EVAL Menu Launcher Demonstration
  ******************************************************************************
  * @attention
  *
...
This module will allow the user to select a sub-demo from the list of five demos displayed: Audio player,
TouchGFX, STemWin, EmbedddedWizrad and Clock&Weather.
