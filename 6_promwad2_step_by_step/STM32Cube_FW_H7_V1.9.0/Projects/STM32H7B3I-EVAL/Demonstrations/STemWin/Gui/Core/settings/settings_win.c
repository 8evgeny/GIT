...
#define ID_TEXT_CORE_0            (GUI_ID_USER + 0x09)
#define ID_TEXT_CPU_SPEED         (GUI_ID_USER + 0x0B)
...
static const GUI_WIDGET_CREATE_INFO _aDialog[] = 
{
  ...
  { TEXT_CreateIndirect, "STM32H7B3I", ID_TEXT_BOARD_1,        30, 325, 140,  20, (GUI_TA_HCENTER | GUI_TA_VCENTER), 0x0, 0 },
  { TEXT_CreateIndirect, "-EVAL",  ID_TEXT_BOARD_2,            30, 345, 140,  20, (GUI_TA_HCENTER | GUI_TA_VCENTER), 0x0, 0 },
  { TEXT_CreateIndirect, "STM32H7", ID_TEXT_CORE_0,         230, 335, 140,  20, (GUI_TA_HCENTER | GUI_TA_VCENTER), 0x0, 0 },
  { TEXT_CreateIndirect, "280MHz", ID_TEXT_CPU_SPEED,     430, 335, 140,  20, (GUI_TA_HCENTER | GUI_TA_VCENTER), 0x0, 0 },
  { TEXT_CreateIndirect, "V1.0.0", ID_TEXT_VERSION_1,         630, 335, 140,  20, (GUI_TA_HCENTER | GUI_TA_VCENTER), 0x0, 0 },

  { TEXT_CreateIndirect, "Copyright (c) STMicroelectronics 2019", ID_TEXT_COPYRIGHT, 550, 450, 240, 20, 0, 0x0, 0 },
};
...
static void _cbDialog(WM_MESSAGE * pMsg)
{
  ...
  switch (pMsg->MsgId) 
  {
    case WM_INIT_DIALOG:
      ...
      hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_CORE_0);
      TEXT_SetFont(hItem, &GUI_Font20B_1);
      TEXT_SetTextColor(hItem, 0xFF39A9DC);

      /* Initialization of 'CPU0 Speed : 400MHz' */
      hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_CPU_SPEED);
      TEXT_SetFont(hItem, &GUI_Font20B_1);
      TEXT_SetTextColor(hItem, 0xFF39A9DC);
