/**
  ...
  * @brief   Description of STM32H7B3I-EVAL STemWin Demonstration
  ******************************************************************************
  * @attention
  *
...
The STM32 H7 STemWin demonstration is running on STM32H7B3I-EVAL boards 
...
3- Connect the STM32H7B3I-EVAL board to PC with USB cable through CN14 and click on STM32CubeProgrammer "Connect" button
...
5- copy the BMP files format with 800x480 pixels as resolution provided under "/Media/Pictures" in a SD card storage at BMP folder
