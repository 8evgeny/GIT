...
private:
    static const int MAX_NUMBER_OF_TEXTS = 32;
    static const int MAX_TEXT_SIZE = 6;
    ...
    Unicode::UnicodeChar textbuf[MAX_NUMBER_OF_TEXTS][MAX_TEXT_SIZE];

    MoveAnimator<Container> centerTextContainer;
    FadeAnimator<TextAreaWithOneWildcard> centerTexts[MAX_NUMBER_OF_TEXTS];
    Unicode::UnicodeChar centerTextbuf[MAX_NUMBER_OF_TEXTS][MAX_TEXT_SIZE];
