...
STM32H7B3I-EVAL LEDs are used to monitor the encryption/decryption and TAG generation  status:
...
@par Directory contents 
  ...
  - CRYP/CRYP_AESCCM_IT/Inc/stm32h7b3i_eval_conf.h  STM32H7B3I_EVAL board configuration file
...
@par Hardware and Software environment
  ...
  - This example has been tested with an STMicroelectronics STM32H7B3I-EVAL
