...
STM32H7B3I-EVAL board's LEDs can be used to monitor the transfer status:
 - LED1 is ON when the transfer is completed without error.
 - LED2 is ON when there is a transfer error.
 - LED3 is ON when there are errors in initialization.
...
@par Directory contents
  ...
  - DMA/DMA_FLASHToRAM/Src/system_stm32h7xx.c    STM32H7xx system source file
  ...
  - DMA/DMA_FLASHToRAM/Inc/stm32h7b3i_eval_conf.h      STM32H7B3I-EVAL Board configuration file
