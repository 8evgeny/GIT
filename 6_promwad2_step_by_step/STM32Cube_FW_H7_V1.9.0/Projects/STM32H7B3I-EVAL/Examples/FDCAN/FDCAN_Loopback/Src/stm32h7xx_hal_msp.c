/**
  ******************************************************************************
  * @file    FDCAN/FDCAN_Loopback/Src/stm32h7xx_hal_msp.c
...
void HAL_FDCAN_MspInit(FDCAN_HandleTypeDef* hfdcan)
{
  ...
  /* Select PLL2Q as source of FDCANx clock */
  RCC_PeriphClkInit.PeriphClockSelection = RCC_PERIPHCLK_FDCAN;
  RCC_PeriphClkInit.FdcanClockSelection = RCC_FDCANCLKSOURCE_PLL2;
  RCC_PeriphClkInit.PLL2.PLL2M = 12;
  RCC_PeriphClkInit.PLL2.PLL2N = 200;
  RCC_PeriphClkInit.PLL2.PLL2P = 2;
  RCC_PeriphClkInit.PLL2.PLL2R = 2;
  RCC_PeriphClkInit.PLL2.PLL2Q = 20; /* fdcan_ker_ck = 20 MHz */
