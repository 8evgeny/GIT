...
The STM32H7B3I-EVAL board LEDs can be used to monitor the transfer status:
...
@par Directory contents
  ...
  - FLASH/FLASH_EraseProgram/Inc/stm32h7b3i_eval_conf.h      STM32H7B3I-EVAL board configuration file
