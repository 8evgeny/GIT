...
int main(void)
{
  ...
  */
  ...
  /* Register HAL EXTI Line linked to WAKEUP button */
  HAL_EXTI_GetHandle(&hpb_exti, EXTI_LINE_0);
  HAL_EXTI_RegisterCallback(&hpb_exti,  HAL_EXTI_COMMON_CB_ID, PB_Callback);
...
/**
  * @brief  This function handles Wakeup-Button interrupt requests.
  * @retval None
  */
void PB_IRQHandler(void)
{
  HAL_EXTI_IRQHandler(&hpb_exti);
}
