...
The HCLK for D1 Domain AXI and AHB3 peripherals , D2 Domain AHB1/AHB2 peripherals and D3 Domain AHB4  peripherals at 280 MHz/2.
The APB clock dividers for D1 Domain APB3 peripherals, D2 Domain APB1 and APB2 peripherals and D3 Domain APB4 peripherals to run at 280 MHz/4.
...
In case the MD5 digest is computed correctly the orange LED (LED4) is turned ON.
...
@par Directory contents 
  ...
  - HASH/HASH_SHA1MD5/Inc/stm32h7b3i_eval_conf.h  STM32H7B3I-EVAL board configuration file
...
@par Hardware and Software environment
    ...
    - This example runs on STM32F7B3xx devices.
