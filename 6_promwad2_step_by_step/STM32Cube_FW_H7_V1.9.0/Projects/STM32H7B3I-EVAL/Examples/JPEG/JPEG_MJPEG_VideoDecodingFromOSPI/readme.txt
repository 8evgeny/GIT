...
@note To Run this example , you can use an MJPEG “.avi” file from
     ...
     This file must have the following properties:
        ...
        - resolution : less or equal to the LCD-DSI screen (i.e 800x480 for the STM32H7B3I-EVAL board)
        - Width  : <=800
        - Height : <= 480
...
Display, Graphics, MJPEG, Video, Decoding, LCD, JPEG Hardware Decoder,
...
@par Directory contents
  ...
  - JPEG/MJPEG_VideoDecodingFromOSPI/Inc/stm32h7b3i_eval_conf.h  STM32H7B3I-EVAL board configuration file
  - JPEG/MJPEG_VideoDecodingFromOSPI/Inc/mx25lm51245g_conf.h     MX25LM51245G OSPI memory configuration file
  - JPEG/MJPEG_VideoDecodingFromOSPI/Inc/is42s32800j_conf.h      IS42S32800J SDRAM memory configuration file
...
@par Hardware and Software environment
  ...
  - Please ensure that the JP4 and JP23 are  in OCSPI1 position
  - Flash one of the MJPEG video files to the OSPI external Flash using STM32CubeProgrammer utility
      The file must have the following properties:
        - resolution : less or equal to the LCD screen (i.e 800x480 for the STM32H7B3I-EVAL board)
        - Width  : <=800
        - Height : <= 480
      The MJPEG file can be in “AVI” container format.
  - Use STM32CubeProgrammer utility version v2.1.0 or higher.
  - Click on "External Loader" from the bar menu then check "mx25lm51245g_STM32H7B3I-EVAL" box
