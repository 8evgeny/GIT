...
@note the MDMA linked list Nodes addresses must be 64 bits aligned and must be in the AXI address space.
      ...
      are located in the CD AXI-SRAM which is cacheable.

STM32H7B3I-EVAL 's LEDs can be used to monitor the transfer status:
...
@par Directory contents
  ...
  - MDMA/MDMA_LTDC_Triggering/Inc/is42s32800j_conf.h          IS42S32800J SDRAM memory configuration file
  - MDMA/MDMA_LTDC_Triggering/Inc/ft5336_conf.h               FT5336 capacitive touch panel configuration file
  - MDMA/MDMA_LTDC_Triggering/Inc/stm32h7b3i_eval_conf.h      STM32H7B3I-EVAL board configuration file
