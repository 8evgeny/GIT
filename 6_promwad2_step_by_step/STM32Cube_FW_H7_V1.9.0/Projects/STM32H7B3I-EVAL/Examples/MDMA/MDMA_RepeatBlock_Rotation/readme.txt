...
@par Example Description
 ...
 - config 4 :
   ...
   STM32H7B3I-EVAL 's  LED can be used to monitor the transfer status:
...
@par Directory contents
    ...
    - MDMA/MDMA_Repeat_BLock/Inc/is42s32800j_conf.h      IS42S32800J SDRAM memory configuration file
    - MDMA/MDMA_Repeat_BLock/Inc/stm32h7b3i_eval_conf.h  STM32H7B3I-EVAL board configuration file
