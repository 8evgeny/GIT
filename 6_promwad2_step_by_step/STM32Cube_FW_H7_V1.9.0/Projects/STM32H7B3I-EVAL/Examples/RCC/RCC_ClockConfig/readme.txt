...
In this example the SYSCLK /4 is outputted on the MCO2 pin(PC.09).
 => PC.09 connected to pin 45 in CN5 connector
...
@par Directory contents 
  ...
  - RCC/RCC_ClockConfig/Inc/stm32h7b3i_eval_conf.h  STM32H7B3I-EVAL board configuration file
...
@par Hardware and Software environment
  ...
  - This example has been tested with STM32H7B3I-EVAL 
