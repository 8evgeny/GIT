...
Once started, LED1 is toggling on STM32H7B3I-EVAL.
...
@par Directory contents  
  ...
  - SAI/SAI_AudioPlay/Inc/stm32h7b3i_eval_conf.h  STM32H7B3I-EVAL board configuration file
...
@par Hardware and Software environment
  ...
  - STM32H7B3I-EVAL Set-up :
    - Plug headset on CN18 connector (Headset).
