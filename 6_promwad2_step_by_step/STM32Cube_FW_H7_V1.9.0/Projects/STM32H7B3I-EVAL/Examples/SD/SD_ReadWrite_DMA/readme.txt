...
The transfer clock is set at 50MHz (SDMMC_CLK / Clock_DIV * 2) are configured within the
SD Handle init parameters.
After initialization, the driver check SD Card capability and switch to High Speed mode if
...
Storage, SD, SDMMC, Read Write, Block, sector, DMA
...
@par Hardware and Software environment
  ...
  - An SD card is need to be plugged to the uSD1 connector in Eval Board.

  - You can display test message  on the HyperTerminal,
      * You need to connect a null-modem female/female RS232 cable between the DB9 (CN9)
        connector(USART) and PC serial port.
