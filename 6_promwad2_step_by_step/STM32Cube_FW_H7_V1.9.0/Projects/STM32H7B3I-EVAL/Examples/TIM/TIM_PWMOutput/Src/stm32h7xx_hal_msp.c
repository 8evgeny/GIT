...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef *htim)
{
  ...
  /* Configure PE.09 (pin12 in CN12) (TIM1_Channel1), PE.11 (pin16 in CN12) (TIM1_Channel2), PE.13 (pin19 in CN12) (TIM1_Channel3),
     PA.11 (pin43 in CN5) (TIM1_Channel4) in output, push-pull, alternate function mode
  */
