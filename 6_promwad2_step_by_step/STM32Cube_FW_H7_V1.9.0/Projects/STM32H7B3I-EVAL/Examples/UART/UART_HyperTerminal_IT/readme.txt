...
clock (SYSCLK) to run at 280 MHz for STM32H7B3xxQ Devices.
...
@par Directory contents
  ...
  - UART/UART_Hyperterminal_IT/Inc/stm32h7b3i_eval_conf.h  STM32H7B3I_EVAL board configuration file
