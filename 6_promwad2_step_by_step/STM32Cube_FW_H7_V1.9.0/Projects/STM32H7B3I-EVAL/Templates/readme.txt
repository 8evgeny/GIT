...
@Note User can choose where to locate the default RAM region as follows:
		...
		- Cube IDE:
			Go to Project properties: C/C++ Build-->Settings--> Tools settings --> MCU GCC Linker --> General:
				...
				- For CD-AXI SRAM select: ../STM32H7B3LIHXQ_FLASH_SRAM1.ld

@par Keywords

System, HAL template, Clock Configuration, HSE, System clock, Oscillator, PLL
...
@par Directory contents
  ...
  - Templates/Inc/stm32h7b3i_eval_conf.h STM32H7B3I_EVAL board configuration file
  - Templates/Inc/mx25lm51245g_conf.h    MX25LM51245G OSPI memory Description file
  - Templates/Inc/ft5336_conf.h          Specific configuration for the capacitive touch panel that can be modified by user.
  - Templates/Inc/is42s32800j_conf.h     Configurations required for the IS42S32800J SDRAM memory.
