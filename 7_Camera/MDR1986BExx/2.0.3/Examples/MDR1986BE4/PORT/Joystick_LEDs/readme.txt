  /**
  @addtogroup PORT_Joystick_LEDs PORT_Joystick_LEDs for MDR1986BE4 evaluation board
  @latexonly
  @verbatim
...
@par Directory contains:
    ...
    - main.c    Main program
    - MT_107_MELT.h    LED display control functions prototypes.
    - MT_107_MELT.c    LED display control functions.
...
To launch the example, you must do the following:
    ...
    - Add main.c file.
    - Add MT_107_MELT.c and MT_107_MELT.h files.
