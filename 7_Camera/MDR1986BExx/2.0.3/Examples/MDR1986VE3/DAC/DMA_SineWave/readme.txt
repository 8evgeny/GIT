  /**
  @addtogroup DAC_DMA_SineWave_3T DAC_DMA_SineWave for MDR1986VE3 evaluation board
  @latexonly
  @verbatim
...
@par Directory contains:
    ...
    - main.c               Main program
    - MDR1986VE3_IT.       Main Interrupt Service Routines
    - MDR1986VE3_IT.       Functions prototypes for the interrupt
