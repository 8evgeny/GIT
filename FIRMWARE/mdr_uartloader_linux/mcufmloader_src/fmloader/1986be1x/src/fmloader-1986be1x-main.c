 ...
 *---------------------------------------------------------------------------
 *
 *  File fmloader-1986be1x-main.c: Firmware loader (MCU 1986BE1x).
 *
 *===========================================================================*/
...
//MCU flash memory start: 0x0000000, size: 128K
...
//Read/write data within UART1 (MCU C4/C3 pins)
#define UART1				((_uart     *) 0x40030000)

//PER_CLOCK register
#define PER_CLOCK			(*(__io_reg *)(0x40020000 + (0x07 << 2)))

//BKP OE register
#define BKP_REG_OE 			(*(__io_reg *)(0x400D8000 + (0x0E << 2)))
...
//Id string
const unsigned char fmloader_id[FMLOADER_ID_LENGTH] = "1986be1xfldr";
...
/*===========================================================================
 * End of file fmloader-1986be1x-main.c
 *===========================================================================*/
