 ...
 *---------------------------------------------------------------------------
 *
 *  File fmloader-1986be9x-main.c: Firmware loader (MCU 1986BE9x).
 *
 *===========================================================================*/
...
//Read/write data within UART2 (MCU F0/F1 pins)
#define UART2				((_uart   *) 0x40038000)
...
//Id string
const unsigned char fmloader_id[FMLOADER_ID_LENGTH] = "1986be9xfldr";
...
/*===========================================================================
 * End of file fmloader-1986be9x-main.c
 *===========================================================================*/
