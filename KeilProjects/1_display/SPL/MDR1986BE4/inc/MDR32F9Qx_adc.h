...
#if defined (MDR_LEGACY_SUPPORT) && (MDR_LEGACY_SUPPORT) == 153
    #warning "Legacy v1.5.3: ADCx_FLAG_OVERWRITE, ADCx_FLAG_OUT_OF_RANGE and ADCx_FLAG_END_OF_CONVERSION will be removed and replaced with ADC1_FLAG_OVERWRITE, ADC1_FLAG_OUT_OF_RANGE and ADC1_FLAG_END_OF_CONVERSION"
    #define ADCx_FLAG_OVERWRITE          ADC1_FLAG_OVERWRITE
    #define ADCx_FLAG_OUT_OF_RANGE       ADC1_FLAG_OUT_OF_RANGE
    #define ADCx_FLAG_END_OF_CONVERSION  ADC1_FLAG_END_OF_CONVERSION
...
#if defined (MDR_LEGACY_SUPPORT) && (MDR_LEGACY_SUPPORT) == 153
    #warning "Legacy v1.5.3: ADCx_IT_OUT_OF_RANGE and ADCx_IT_END_OF_CONVERSION will be removed and replaced with ADC1_IT_OUT_OF_RANGE and ADC1_IT_END_OF_CONVERSION"
    #define ADCx_IT_OUT_OF_RANGE       ADC1_IT_OUT_OF_RANGE
    #define ADCx_IT_END_OF_CONVERSION  ADC1_IT_END_OF_CONVERSION
    
    #define IS_ADCx_CONFIG_IT(IT)    (((IT) & (ADCx_IT_OUT_OF_RANGE | ADCx_IT_END_OF_CONVERSION)) == IT)
#endif /* MDR_LEGACY_SUPPORT 153 */
...
{
#if defined (MDR_LEGACY_SUPPORT) && (MDR_LEGACY_SUPPORT) == 153
    #warning "Legacy v1.5.3: ADC_StartDelay value of ADC_InitTypeDef structure will be removed as not used"
...
#if defined (MDR_LEGACY_SUPPORT) && (MDR_LEGACY_SUPPORT) == 153
    #warning "Legacy v1.5.3: ADC_GetStatus() will be removed and replaced with ADC1_GetStatus()"
    #define ADC_GetStatus ADC1_GetStatus
#endif /* MDR_LEGACY_SUPPORT 153 */

FlagStatus ADC1_GetFlagStatus(ADC1_Flags Flag);
#if defined (MDR_LEGACY_SUPPORT) && (MDR_LEGACY_SUPPORT) == 153
    #warning "Legacy v1.5.3: ADC_GetFlagStatus() will be removed and replaced with ADC1_GetFlagStatus()"
...
#if defined (MDR_LEGACY_SUPPORT) && (MDR_LEGACY_SUPPORT) == 153
    #warning "Legacy v1.5.3: ADC_ITConfig() will be removed and replaced with ADC1_ITConfig()"
    #define ADC_ITConfig(ADC_IT, NewState) ADC1_ITConfig(ADC_IT, NewState)
#endif /* MDR_LEGACY_SUPPORT 153 */

ITStatus ADC1_GetITStatus(uint32_t ADC_IT);
#if defined (MDR_LEGACY_SUPPORT) && (MDR_LEGACY_SUPPORT) == 153
    #warning "Legacy v1.5.3: ADC_GetITStatus() will be removed and replaced with ADC1_GetITStatus()"
    #define ADC_GetITStatus(ADC_IT) ADC1_GetITStatus(ADC_IT)
#endif /* MDR_LEGACY_SUPPORT 153 */
