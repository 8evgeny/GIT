...
yellMsg::yellMsg(ufw::arcCrypt *crypt):
    basicMessage(0)//QRandomGenerator::QRandomGenerator::securelySeeded().bounded(ISLP_YELL_MINSIZE,ISLP_YELL_MAXSIZE))
{
//    keyring=crypt;
//    IPS_FUNCTION_DBG
//    generatePayload();
