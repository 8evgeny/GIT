...
__vector_table
        ...
        DCD     ADC10_IRQHandler           ; 199
        DCD     ADC_FIFO10_IRQHandler      ; 200
        DCD     ADC20_IRQHandler           ; 201
        DCD     ADC_FIFO20_IRQHandler      ; 202
        DCD     ADC01_IRQHandler           ; 203
        DCD     ADC_FIFO01_IRQHandler      ; 204
        DCD     ADC11_IRQHandler           ; 205
        DCD     ADC_FIFO11_IRQHandler      ; 206
        DCD     ADC21_IRQHandler           ; 207
        DCD     ADC_FIFO21_IRQHandler      ; 208
...
CMP3_IRQHandler
        ...
        PUBWEAK ADC21_IRQHandler
        SECTION .text:CODE:NOROOT(1)
ADC21_IRQHandler
        B ADC21_IRQHandler

        PUBWEAK ADC_FIFO21_IRQHandler
        SECTION .text:CODE:NOROOT(1)
ADC_FIFO21_IRQHandler
        B ADC_FIFO21_IRQHandler
...
ADC_FIFO01_IRQHandler
        ...
        PUBWEAK ADC20_IRQHandler
        SECTION .text:CODE:NOROOT(1)
ADC20_IRQHandler
        B ADC20_IRQHandler

        PUBWEAK ADC_FIFO20_IRQHandler
        SECTION .text:CODE:NOROOT(1)
ADC_FIFO20_IRQHandler
        B ADC_FIFO20_IRQHandler
