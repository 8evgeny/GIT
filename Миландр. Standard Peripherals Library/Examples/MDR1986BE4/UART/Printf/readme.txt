  /**
  @addtogroup UART_Printf UART_Printf for MDR1986BE4 evaluation board
  @latexonly
  @verbatim
...
Configure UART1 on an exchange with 19200 Baud rate, 8 bit data size, 1 stop-bit and no parity check.
Configure PORTB line 0 as UART1_TXD.
Configure PORTB line 1 as UART1_RXD.
...
@par Hardware and Software environment:
    ...
    - This example is intended to run on MDR1986BE4 evaluation board with MDR1986BE4 microcontroller.
