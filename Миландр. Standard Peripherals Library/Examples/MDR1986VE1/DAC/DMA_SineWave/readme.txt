  /**
  @addtogroup DAC_DMA_SineWave_1T DAC_DMA_SineWave for MDR1986VE1T evaluation board
  @latexonly
  @verbatim
...
@par Directory contains:
    ...
    - main.c               Main program
    - MDR1986VE1T_IT.      Main Interrupt Service Routines
    - MDR1986VE1T_IT.      Functions prototypes for the interrupt
