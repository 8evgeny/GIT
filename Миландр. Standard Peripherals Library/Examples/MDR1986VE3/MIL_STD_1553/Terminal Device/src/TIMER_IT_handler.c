/**
  ...
  * @version V2.0.2
  * @date    21/09/2021
  * @brief   This file contains Timer interrupt handler
  ******************************************************************************
  * <br><br>
  *
...
void My_TIMER1_IRQ_Handler(MDR_TIMER_TypeDef * TIMERx, MDR_MIL_STD_1553_TypeDef * MIL_STD_1553x)
{
    ...
    switch (MIL_STD_1553_MSG)
    {
        case 0x0001:
            ...
            {
                /* Have group command terminal device -> terminal device */
            ...
            else
            {
                ...
                {
                    //режим тестирования (циркулярного возврата данных)
        ...
        case 0x0080:
            ...
            if(MIL_STD_1553_GetMSG(MIL_STD_1553x) == 0x0004)
            {
                /* Have not group command terminal device -> terminal device */
                MIL_STD_1553_MSG = MIL_STD_1553_GetMSG(MIL_STD_1553x);
                MIl_STD_1553CommandWord2 = MIL_STD_1553_GetCommandWord(MIL_STD_1553x, MIL_STD_1553_COMMAND_WORD2);
            }
            else
...
/** @} */ /* End of group MIL_STD_1553_Terminal_Device_VE3 */
