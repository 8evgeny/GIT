  ...
  * @version V1.0.0
  * @date    02/09/2015
  * @brief   Description of the ADC GO Example.
  ******************************************************************************
...
This example shows how to configure ADC channels and test them in ADC GO mode.

@par Directory "Examples/adc_go" contains:
