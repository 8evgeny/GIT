  ...
  * @version V1.0.0
  * @date    02/09/2015
  * @brief   Description of the tim_PWM Example.
  ******************************************************************************
...
This example shows how to configure TIMER in PWM mode, output signal with const CCR value.

@par Directory "Examples/tim_PWM" contains:
